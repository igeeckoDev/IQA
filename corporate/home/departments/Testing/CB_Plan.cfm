...
<!--- Start of Page File --->
<cfset subTitle = "Certification Body (CB) Coverage - IQA Activity">
...
<b>Site Audits</b><br />
This page shows all Certification Body (CB) Audits. For more information, please view the Legend and Footnotes at the bottom of this page.<br /><br />
