...
<cfelseif url.type is "auditor">
 AND  (LeadAuditor = '#url.type2#' or Auditor = '#url.type2#')
...
<cfset title = "Audit Calendar for <cfoutput>#DateFormat(CurntDate,"mmmm, YYYY")#</cfoutput>">
...
<cfloop index="i" to="2012" from="2004">
