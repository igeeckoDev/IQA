...
Subject: Quality System Audit of <B> <cfif AuditType2 is "Program" or AuditType2 is "Corporate" or AuditType2 is "Global Function/Process"><cfelseif AuditType2 is "MMS - Medical Management Systems">Medical Management Systems - <cfelse>[OfficeName] - </cfif>[Area]</B> <br><br>

Dear <B>[Name]</B>,<br><br>

This is to confirm our communications pertaining to the<cfif desk is "Yes"> desk</cfif> audit of UL <B>[OfficeName] - [Area]</B> that is scheduled for <B>[StartDate]</B>. <B>[LeadAuditor]</B> is the Lead Auditor for this audit, which will begin with an opening session to review the audit scope and coordinate audit activities with you and your staff. <!---<cfif Aud is "" or Aud is "- None -"><cfelse><b>[Aud]</b> will be assisting on this audit.</cfif>---><br><br>
...
All Findings and Observations noted during the audit will be discussed with you during a formal closing session on <B>[EndDate]</B>.<br><br></cfif>
