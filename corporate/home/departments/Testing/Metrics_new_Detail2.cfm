...
<tr>
	...
	SELECT COUNT(*) as Count, Year_, Area
	FROM AuditSchedule
	...
	<tr>
		...
		<td align=left>
			<cfif count gt 1 AND Area eq "Processes"
				OR count gt 1 AND Area eq "Processes and Labs">
				<a href="Metrics_New_Detail3.cfm?#CGI.Query_String#&Area=#Area#">#Area#</a>
			<cfelse>
				#Area#
			</cfif>
		</td>
