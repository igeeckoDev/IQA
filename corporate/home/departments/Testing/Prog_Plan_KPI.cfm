...
Year:<cfloop index="k" from="2006" to="#curYear#"> [<a href="Prog_Plan_KPI.cfm?View=#URL.View#&Year=#k#">#k#</a>] </cfloop><br /><br>

<cfif startYear eq StartYear>
	<cfset allCount = 0>
	<cfset blankCount = 0>
</cfif>

<!--- set table width --->
<cfset tWidth = 350 + (((StartYear - startyear) + 1) * 100)>
...
<tr>
    ...
    <cfloop index="i" from="#URL.Year#" to="#URL.Year#">
    <cfset colspan = (#StartYear# - #StartYear#) + 1>
...
<cfset yearCompare = Compare(StartYear, StartYear)>
<cfset i = 1>
...
ORDER BY AuditSchedule.Year_, AuditSchedule.ID
    ...
    <cfelse>
		<cfloop index="j" from="#startYear#" to="#StartYear#">
		    <CFQUERY BLOCKFACTOR="100" name="ResultsProgAudit" Datasource="Corporate">
