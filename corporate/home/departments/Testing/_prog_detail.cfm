...
<cfif len(ProgramSummary)>
	...
	= toOpen? '<a>Hide [-]</a>':'<a>View [+]</a>' ;
	}
	</script>

<dl class="togList">
	<b>Program Summary</b>
	<dt onclick="tog(this)"><span><a>View [+]</a></span></dt>
...
<cfif len(Manual)>
  <cfif url.progid is 71>
     <cfloop list="#Manual#" index="i">
       <a href="#i#" onClick="javascript: pageTracker._trackPageview('/downloads/cam'); ">#i#</a>
     </cfloop>
	<cfelse>
     <cfloop list="#Manual#" index="i">
       <a href="#i#">#i#</a>
...
<cfoutput query="ProgDetail">
	...
	SELECT * from ProgDev
	WHERE ID = <cfqueryparam value="#ProgDetail.Parent#" cfsqltype="CF_SQL_INTEGER">
	</CFQUERY>
</cfoutput>
...
<cfif NOT len(ProgOwner) OR ProgOwner is "-">No Program Owner Listed<cfelse>#ProgOwner# - (<a href="mailto:#POEmail#">#POEmail#</a>)</cfif><br>
<u>Owner</u> - #LocOwner#<br>
<u>Region</u> - #Region#<br><br>

<b>Program Manager</b><br>
<cfif NOT len(Manager) OR Manager is "-">No Program Manager Listed<cfelse>#Manager# - (<a href="mailto:#PMEmail#">#PMEmail#</a>)</cfif>
<br><br>
...
<cfif NOT len(officename)>
No Locations Listed
<cfelse>
<!---<cfif ProgHolder IS NOT Program>
<cfIf len(ProgHolder)><br></cfif>
</cfif>
	<cfif ATHolder IS NOT ActivityType>
	<cfIf len(ATHolder)><br></cfif>
	<b>#ActivityType#</b><br>
	</cfif>--->
	&nbsp; - #OfficeName#<br>
...
<b>Status</b><br>
<cfif NOT len(Status)>Active
<cfelseif Status is "Withdrawn">#Status# - #dateformat(EndDate, "mm/dd/yyyy")#
<cfelseif Status is "Pending">#Status#<cfif len(StartDate)> - #dateformat(StartDate, "mm/dd/yyyy")#</cfif>
<cfelse>#Status#
</cfif><br><br>
...
<A HREF="javascript:sitePopUp('_prog_rh.cfm?progID=#url.progID#')">View</a> Revision History<br><br>
</cfoutput>
