...
<cfset subTitle = "Audit Details - #URL.Year#-#URL.ID# #URL.OfficeName# - Add Accreditations">
...
<cfform 
    ...
    width="700" 
    preservedata="yes"  
    Action="AuditDetails_SelectAccreditations.cfm?OfficeName=#URL.OfficeName#&ID=#URL.ID#&Year=#URL.Year#">
