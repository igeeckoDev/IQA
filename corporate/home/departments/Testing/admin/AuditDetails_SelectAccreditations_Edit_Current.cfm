...
<cfset subTitle = "Audit Details - #URL.Year#-#URL.ID# #URL.OfficeName# - Edit Accreditations">
<cfinclude template="#SiteDir#SiteShared/StartOfPage.cfm">
<!--- / --->

<cfset Loc = "#URL.OfficeName#">
...
<cfFORM METHOD="POST" name="sAccredAction" ACTION="AuditDetails_SelectAccreditations_AccredAction.cfm?Accred=#Form.Accred#&OfficeName=#URL.OfficeName#&ID=#URL.ID#&Year=#URL.Year#">
...
<cfform 
    ...
    width="700" 
    preservedata="yes"  
    Action="AuditDetails_SelectAccreditations_Edit.cfm?OfficeName=#URL.OfficeName#&ID=#URL.ID#&Year=#URL.Year#">
...
<cfelse>
    ...
    <cfoutput>
        ...
        WHERE 
            IQAtblOffices.ID = AccredLocations.OfficeID
            AND Accreditors.ID = AccredLocations.AccredID
            AND IQAtblOffices.OfficeName = '#Super.OfficeName#'
        ORDER BY
            Accreditors.Accreditor, AccredLocations.AccredType
        </cfquery>
		...
		<cfelse>
        	No Accreditations Listed for #Super.OfficeName#<Br><br>
        </cfif>
    </cfoutput>
</CFIF>
<!--- /// --->
