...
<cfset subTitle = "<a href='AuditPlanning.cfm?Year=#URL.year#'>#URL.Year# Audit Planning</a> - Uncancel Audit">
...
<cfelse>
	...
	Are you are you want to uncancel this audit?<br><br>
	...
	Notes:<br>
	<textarea WRAP="PHYSICAL" ROWS="5" COLS="60" NAME="Notes" displayname="Notes" value="#Notes#">#Notes#</textarea>

	<input type="Submit" name="Submit" value="Reinstate/Uncancel this Audit to the Planning Module">
	</form>
	</cfoutput>
</cfif>
