...
<cfset subTitle = "Audit Report Confirmation - #url.year#">
...
<cfelse>
	...
	<tr>
		...
		<th>Lead Auditor</th>
		<th>Audit Details</th>
		<th>Confirmation - Scope Letter Send</th>
		<th>Confirmation - Report Publication</th>
	</tr>
	</cfif>
<tr>
<!--- Audit Number --->
...
<!--- Scope --->
<CFQUERY BLOCKFACTOR="100" name="Confirm" Datasource="UL06046" username="#OracleDB_Username#" password="#OracleDB_Password#">
SELECT Confirm, Auditor
FROM IQAScopeConfirm
WHERE Year_ = #url.Year#
AND ID = #ID#
</cfquery>

<!--- Confirmation --->
<td align="center"><cfif len(Confirm.Confirm)>#Confirm.Confirm# - #Confirm.Auditor#<cfelse>--</cfif></td>

<!--- Report --->
<CFQUERY BLOCKFACTOR="100" name="Confirm" Datasource="UL06046" username="#OracleDB_Username#" password="#OracleDB_Password#">
SELECT Confirm, Auditor
FROM IQAReportConfirm
WHERE Year_ = #url.Year#
AND ID = #ID#
</cfquery>
