...
<cfset subTitle = "<A href=AuditMatrix_DAP.cfm?Year=#curYear#>View DAP Audit Schedule</a> - Reinstate DAP Audit">
...
<cflock scope="Session" timeout="5">
	<cfset historyUpdate = "Audit Reinstated on #curdate# #curtime# by #SESSION.Auth.UserName#<br>Reinstate Notes: #Form.ReinstateNotes#">
...
<cfelse>
	...
	Do you wish to reinstate this audit? Please ensure the month and audit dates are in the future, by editing the audit after you have reinstated it.<br><br>
	...
	Reinstate Notes:<br>
	<textarea WRAP="PHYSICAL" ROWS="5" COLS="60" NAME="ReinstateNotes" displayname="ReinstateNotes" value=""></textarea><br><br>
	...
	<input name="submit" type="submit" value="Reinstate Audit">
