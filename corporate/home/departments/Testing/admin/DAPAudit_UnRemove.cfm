...
<cfset subTitle = "<A href=AuditMatrix_DAP.cfm?Year=#curYear#>View DAP Audit Schedule</a> - Un-Remove DAP Audit">
...
<cflock scope="Session" timeout="5">
	<cfset historyUpdate = "Audit Returned to the Audit Schedule (previously Deleted) by #SESSION.Auth.UserName#<br>Un-Remove Notes: #Form.UnRemoveNotes#">
...
<cfelse>
	...
	Do you wish to Un-Remove this audit from the audit schedule? it will be returned to the audit schedule.<br><br>
	...
	Un-Remove Notes:<br>
	<textarea WRAP="PHYSICAL" ROWS="5" COLS="60" NAME="UnRemoveNotes" displayname="UnRemoveNotes" value=""></textarea><br><br>
	...
	<input name="submit" type="submit" value="Un-Remove Audit">
