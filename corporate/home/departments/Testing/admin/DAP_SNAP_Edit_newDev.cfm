...
<!--- get Data Acceptance record to save data as the same as the qualification record --->
<cfif Form.FunctionType eq "Qualification">
    ...
    SELECT ID
    FROM xSNAPData
    WHERE FunctionType = 'Data Acceptance'
    AND FunctionType2 = '#Form.FunctionType2#'
    </CFQUERY>
</cfif>
<!--- /// --->
...
<cfif Form.FunctionType eq "Qualification">
	<cfif Form.FunctionType2 eq "WTDP" AND Form.WTDPCompliance eq "NA"
	OR	Form.FunctionType2 eq "TCP" AND Form.TCPQualification eq "NA"
	OR Form.FunctionType2 eq "PPP" AND Form.TCPQualification eq "NA">
...
<u>Function/Program</u>: #FunctionType# / #FunctionType2#
</cfoutput><br><br>
