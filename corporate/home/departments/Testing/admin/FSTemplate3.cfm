...
All Findings and Observations noted during the audit will be discussed with you during a formal closing session anticipated for the afternoon of #DateFormat(EndDate, 'mmmm dd, yyyy')#.
