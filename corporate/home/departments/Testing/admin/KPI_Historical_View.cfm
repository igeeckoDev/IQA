...
<cfoutput query="KPI">
<b>Historical KPI View</b><br>
<u>Year</u> #Year_#<br>
<u>Quarter</u> #Quarter#<br>
<u>Date Posted</u> (date of latest revision) #dateformat(DatePosted, "mm/dd/yyyy")#<br><br>
...
$(document).ready(function() {
   ...
   $('#container9').highcharts(json);
	...
	<p class="KPI-Title" align="center">
		C&I Quality Engineering Key Process Indicators</p>

	<p class="KPI-SubTitle" align="center">
		Updated
		<script language="JavaScript">
	...
	<tr>
		<td>
			<div id="container1" style="width:25%; height:300px;"></div>
		</td>
		<td>
