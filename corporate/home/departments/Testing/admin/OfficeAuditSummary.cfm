...
<p align="left">#LastYear# <a href="OfficeAuditSummary.cfm?Year=#CurYear#&OfficeName=#Bob#">[ #CurYear# ]</a> <a href="OfficeAuditSummary.cfm?Year=#NextYear#&OfficeName=#Bob#">[ #NextYear# ]</a><br><br>
<cfelseif URL.Year is CurYear>
<p align="left"><a href="OfficeAuditSummary.cfm?Year=#LastYear#&OfficeName=#Bob#">[ #LastYear# ]</a> #CurYear# <a href="OfficeAuditSummary.cfm?Year=#NextYear#&OfficeName=#Bob#">[ #NextYear# ]</a><br><br>
<cfelseif URL.Year is NextYear>
<p align="left"><a href="OfficeAuditSummary.cfm?Year=#LastYear#&OfficeName=#Bob#">[ #LastYear# ]</a> <a href="OfficeAuditSummary.cfm?Year=#CurYear#&OfficeName=#Bob#">[ #CurYear# ]</a> #NextYear# <br><br>
<cfelse>
</cfif>
</CFOUTPUT>
...
<cfif Summary.AuditedBy is "AS">

<CFOUTPUT query="Summary">
<b><a href="AuditDetails.cfm?ID=#ID#&Year=#Year#">#AuditedBy#-#Year#-#ID#</a></b> - #OfficeName#, #AuditType#, <cfset CompareDate = Compare(StartDate, EndDate)>
...
<cfelseif Summary.AuditType is "Quality System" or Summary.AuditType is "Quality System,Technical Assessment" or Summary.AuditType is "Quality System, Technical Assessment">

<CFOUTPUT query="Summary">
<b><a href="AuditDetails.cfm?ID=#ID#&Year=#Year#">#Year#-#ID#-#AuditedBy#</a></b> - #OfficeName#<cfif AuditArea is ""><cfelse> (#TRIM(AuditArea)#)</cfif>, #AuditType#, <cfset CompareDate = Compare(StartDate, EndDate)>
...
<br>
<CFOUTPUT query="Summary">
<b><a href="AuditDetails.cfm?ID=#ID#&Year=#Year#">#Year#-#ID#-#AuditedBy#</a></b> - #OfficeName#<cfif AuditArea is ""><cfelse> (#TRIM(AuditArea)#)</cfif>, <cfset CompareDate = Compare(StartDate, EndDate)>
