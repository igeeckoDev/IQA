...
All Findings and Observations noted during the audit will be discussed with you during a<cfif Desk is "No"> formal</cfif> closing session on #DateFormat(EndDate, 'mmmm dd, yyyy')#.
