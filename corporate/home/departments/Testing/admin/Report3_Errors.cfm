...
<cfoutput>		  
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="Report4.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#&Skip=No">

Document Control implementation effective?<br>
<A HREF="javascript:popUp('help.cfm?ID=1')">[View Effectiveness Criteria]</A>
<br>
Yes <input type="Radio" Name="DC" Value="Yes" Checked> 
...
<textarea WRAP="PHYSICAL" ROWS="5" COLS="70" NAME="e_DCComments" Value="" displayname="Document Control Implementation Comments"></textarea>
<br><br>

Management Review implementation effective?<br>
<A HREF="javascript:popUp('help.cfm?ID=2')">[View Effectiveness Criteria]</A>
<br>
Yes <input type="Radio" Name="MR" Value="Yes" Checked> 
No <INPUT TYPE="Radio" NAME="MR" value="No"> 
N/A <INPUT TYPE="Radio" NAME="MR" value="NA">
Cannot Determine Effectiveness <INPUT TYPE="Radio" NAME="MR" value="Cannot Determine Effectiveness"><br>

Please add comments:<br>
<textarea WRAP="PHYSICAL" ROWS="5" COLS="70" NAME="e_MRComments" Value="" displayname="Management Review Implementation Comments"></textarea>
<br><br>

Corrective Action implementation effective?<br>
<A HREF="javascript:popUp('help.cfm?ID=3')">[View Effectiveness Criteria]</A>
<br>
Yes <input type="Radio" Name="CA" Value="Yes" Checked> 
...
Please add comments:<br>
<textarea WRAP="PHYSICAL" ROWS="5" COLS="70" NAME="e_CAComments" Value="" displayname="Corrective Action Implementation Comments"></textarea>
<br><br>

Records implementation effective?<br>
<A HREF="javascript:popUp('help.cfm?ID=4')">[View Effectiveness Criteria]</A>
<br>
Yes <input type="Radio" Name="RE" Value="Yes" Checked> 
...
Please add comments:<br>
<textarea WRAP="PHYSICAL" ROWS="5" COLS="70" NAME="e_REComments" Value="" displayname="Records Implementation Comments"></textarea>
<br><br>

Internal Audits implementation effective?<br>
<A HREF="javascript:popUp('help.cfm?ID=5')">[View Effectiveness Criteria]</A>
<br>
Yes <input type="Radio" Name="IA" Value="Yes" Checked> 
...
Please add comments:<br>
<textarea WRAP="PHYSICAL" ROWS="5" COLS="70" NAME="e_IAComments" Value="" displayname="Internal Audits Implementation Comments"></textarea>
<br><br>
...
<br>
Yes <input type="Radio" Name="Net" Value="Yes" Checked> 
...
Please add comments:<br>
<textarea WRAP="PHYSICAL" ROWS="5" COLS="70" NAME="e_NetComments" Value="" displayname="Files and Records Comments"></textarea>
<br><br>
