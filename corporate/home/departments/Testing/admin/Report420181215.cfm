...
<FORM Method="Post" enctype="multipart/form-data" name="Audit" Action="Report4_submit.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">
	<cfelse>
...
<cfelseif Check.AuditType2 eq "Local Function" AND Check.AuditArea EQ "Certification Body (CB) Audit">
	...
	<cfif ID is "3">
		Yes <INPUT TYPE="Radio" NAME="#j##ID#" value="1" checked>
	<cfelseif ID is "8">
		Yes <INPUT TYPE="Radio" NAME="#j##ID#" value="1" checked>
	<cfelseif ID is "11">
		Yes <INPUT TYPE="Radio" NAME="#j##ID#" value="1" checked>
