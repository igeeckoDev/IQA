...
<cfif Check.Desk is "Yes" AND Check.AuditType2 is "Global Function/Process"
	...
	<cflocation url="Report_edit4.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#&skip=Yes" addtoken="no">
...
<FORM id="myform" name="myform" METHOD="POST" ENCTYPE="multipart/form-data" ACTION="Report_edit4.cfm?ID=#ID#&Year=#Year#&AuditedBy=#AuditedBy#&skip=No">
