...
<cfif link is "http://#CGI.Server_Name##curdir#Report_Edit5.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">
...
<cfelseif link is "http://#CGI.Server_Name##curdir#Report_Edit4.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">
