...
<CFSET var2[1][1][1] = '#RCAR1#'>
<CFSET var2[2][1][1] = '#RCAR2#'>
<CFSET var2[3][1][1] = '#RCAR3#'>
<CFSET var2[4][1][1] = '#RCAR4#'>
<CFSET var2[5][1][1] = '#RCAR5#'>
<CFSET var2[6][1][1] = '#RCAR6#'>
<CFSET var2[7][1][1] = '#RCAR7#'>
<CFSET var2[8][1][1] = '#RCAR8#'>
<CFSET var2[9][1][1] = '#RCAR9#'>
<CFSET var2[10][1][1] = '#RCAR10#'>
<CFSET var2[11][1][1] = '#RCAR11#'>
<CFSET var2[12][1][1] = '#RCAR12#'>
<CFSET var2[13][1][1] = '#RCAR13#'>
<CFSET var2[14][1][1] = '#RCAR14#'>
<CFSET var2[15][1][1] = '#RCAR15#'>
<CFSET var2[16][1][1] = '#RCAR16#'>
<CFSET var2[17][1][1] = '#RCAR17#'>
<CFSET var2[18][1][1] = '#RCAR18#'>
<CFSET var2[19][1][1] = '#RCAR19#'>
<CFSET var2[20][1][1] = '#RCAR20#'>

<CFSET var2[1][2][2] = '#Comments1#'>
<CFSET var2[2][2][2] = '#Comments2#'>
<CFSET var2[3][2][2] = '#Comments3#'>
<CFSET var2[4][2][2] = '#Comments4#'>
<CFSET var2[5][2][2] = '#Comments5#'>
<CFSET var2[6][2][2] = '#Comments6#'>
<CFSET var2[7][2][2] = '#Comments7#'>
<CFSET var2[8][2][2] = '#Comments8#'>
<CFSET var2[9][2][2] = '#Comments9#'>
<CFSET var2[10][2][2] = '#Comments10#'>
<CFSET var2[11][2][2] = '#Comments11#'>
<CFSET var2[12][2][2] = '#Comments12#'>
<CFSET var2[13][2][2] = '#Comments13#'>
<CFSET var2[14][2][2] = '#Comments14#'>
<CFSET var2[15][2][2] = '#Comments15#'>
<CFSET var2[16][2][2] = '#Comments16#'>
<CFSET var2[17][2][2] = '#Comments17#'>
<CFSET var2[18][2][2] = '#Comments18#'>
<CFSET var2[19][2][2] = '#Comments19#'>
<CFSET var2[20][2][2] = '#Comments20#'>

<CFSET var2[1][3][3] = '#NewCAR1#'>
<CFSET var2[2][3][3] = '#NewCAR2#'>
<CFSET var2[3][3][3] = '#NewCAR3#'>
<CFSET var2[4][3][3] = '#NewCAR4#'>
<CFSET var2[5][3][3] = '#NewCAR5#'>
<CFSET var2[6][3][3] = '#NewCAR6#'>
<CFSET var2[7][3][3] = '#NewCAR7#'>
<CFSET var2[8][3][3] = '#NewCAR8#'>
<CFSET var2[9][3][3] = '#NewCAR9#'>
<CFSET var2[10][3][3] = '#NewCAR10#'>
<CFSET var2[11][3][3] = '#NewCAR11#'>
<CFSET var2[12][3][3] = '#NewCAR12#'>
<CFSET var2[13][3][3] = '#NewCAR13#'>
<CFSET var2[14][3][3] = '#NewCAR14#'>
<CFSET var2[15][3][3] = '#NewCAR15#'>
<CFSET var2[16][3][3] = '#NewCAR16#'>
<CFSET var2[17][3][3] = '#NewCAR17#'>
<CFSET var2[18][3][3] = '#NewCAR18#'>
<CFSET var2[19][3][3] = '#NewCAR19#'>
<CFSET var2[20][3][3] = '#NewCAR20#'>
</cfoutput>

<cfoutput>
<cfset var3=ArrayNew(2)>				  
<CFSET var3[1][1] = '#Form.e_VCAR1#'>
<CFSET var3[2][1] = '#Form.e_VCAR2#'>
<CFSET var3[3][1] = '#Form.e_VCAR3#'>
<CFSET var3[4][1] = '#Form.e_VCAR4#'>
<CFSET var3[5][1] = '#Form.e_VCAR5#'>
<CFSET var3[6][1] = '#Form.e_VCAR6#'>
<CFSET var3[7][1] = '#Form.e_VCAR7#'>
<CFSET var3[8][1] = '#Form.e_VCAR8#'>
<CFSET var3[9][1] = '#Form.e_VCAR9#'>
<CFSET var3[10][1] = '#Form.e_VCAR10#'>
<CFSET var3[11][1] = '#Form.e_VCAR11#'>
<CFSET var3[12][1] = '#Form.e_VCAR12#'>
<CFSET var3[13][1] = '#Form.e_VCAR13#'>
<CFSET var3[14][1] = '#Form.e_VCAR14#'>
<CFSET var3[15][1] = '#Form.e_VCAR15#'>
<CFSET var3[16][1] = '#Form.e_VCAR16#'>
<CFSET var3[17][1] = '#Form.e_VCAR17#'>
<CFSET var3[18][1] = '#Form.e_VCAR18#'>
<CFSET var3[19][1] = '#Form.e_VCAR19#'>
<CFSET var3[20][1] = '#Form.e_VCAR20#'>

<CFSET var3[1][2] = '#Form.Effective1#'>
<CFSET var3[2][2] = '#Form.Effective2#'>
<CFSET var3[3][2] = '#Form.Effective3#'>
<CFSET var3[4][2] = '#Form.Effective4#'>
<CFSET var3[5][2] = '#Form.Effective5#'>
<CFSET var3[6][2] = '#Form.Effective6#'>
<CFSET var3[7][2] = '#Form.Effective7#'>
<CFSET var3[8][2] = '#Form.Effective8#'>
<CFSET var3[9][2] = '#Form.Effective9#'>
<CFSET var3[10][2] = '#Form.Effective10#'>
<CFSET var3[11][2] = '#Form.Effective11#'>
<CFSET var3[12][2] = '#Form.Effective12#'>
<CFSET var3[13][2] = '#Form.Effective13#'>
<CFSET var3[14][2] = '#Form.Effective14#'>
<CFSET var3[15][2] = '#Form.Effective15#'>
<CFSET var3[16][2] = '#Form.Effective16#'>
<CFSET var3[17][2] = '#Form.Effective17#'>
<CFSET var3[18][2] = '#Form.Effective18#'>
<CFSET var3[19][2] = '#Form.Effective19#'>
<CFSET var3[20][2] = '#Form.Effective20#'>
</cfoutput>

<cfoutput query="Audit">		  
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="TPReport_edit4.cfm?ID=#ID#&Year=#Year#&AuditedBy=#AuditedBy#">
</cfoutput>
...
<tr>
<td valign="top">
<input type="text" name="e_#var[i][1][1]#" value="<cfif var2[i][1][1] is NOT 0>#var2[i][1][1]#<cfelse><cfif var3[i][1] is NOT "0" AND var3[i][2] is "No">#var3[i][1]#<cfelse>0</cfif></cfif>" size="10" displayname="#var[i][1][1]#">
</td>
<td valign="top">
<input type="text" name="e_#var[i][3][3]#" value="#var2[i][3][3]#" size="10" displayname="#var[i][3][3]#">
</td>
<td valign="top">
<textarea WRAP="PHYSICAL" ROWS="3" COLS="60" name="e_#var[i][2][2]#" displayname="#var[i][2][2]#">#htmleditformat(var2[i][2][2])#</textarea>
</td>
</tr>
</cfoutput>
</cfloop>
