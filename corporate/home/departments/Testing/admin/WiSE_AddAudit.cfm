...
<cfset subTitle = "WiSE - Add Internal Audit">
...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="WiSE_AddAudit_Submit.cfm">
...
Audit Area / Scope: (required)<Br />
<INPUT TYPE="TEXT" NAME="e_AuditArea" size="75" VALUE="" displayname="Scope of Audit"><br /><br />

Type of Audit:<br />
WiSE Technical Audit<br /><br />
