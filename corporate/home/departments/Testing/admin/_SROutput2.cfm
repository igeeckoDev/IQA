...
<cfset subtitle = "SRs Generated From #url.Year# IQA Audits - View Quantity by Standard Category">
...
<cfoutput>
    <cfloop index="i" from="2010" to="#curyear#">
		<cfif url.year eq #i#><b>#i#</b><cfelse><a href="_SRoutput2.cfm?Year=#i#">#i#</a></cfif>
    </cfloop>
</cfoutput>
<br />
