...
<cfelseif url.type is "Accred">
	<cfif url.type2 is "AS">
	- Accreditation Services Audits
	<cfelseif url.type2 is "Non">
	- Accreditation Audits (Non-AS)
	<cfelseif url.type2 is "All">
	- All Accreditation Audits
	</cfif>
<cfelseif url.type is "LAB">
...
<!--- toggle to Public --->
<cfinclude template="incToggle.cfm"><br />
...
<div class="blog-time">Audit Calendar Help - <A HREF="javascript:popUp('../webhelp/webhelp_calendar.cfm')">[?]</A></div><br>
...
&nbsp;
<cfelse>
<cfinclude template="#IQARootDir#calendar_search_results.cfm">
</cfif>
