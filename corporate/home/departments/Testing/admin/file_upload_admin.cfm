...
<cffile action="UPLOAD" filefield="Upload" nameconflict="OVERWRITE" destination="#Form.Destination#">

<CFMAIL to="Christopher.J.Nicastro@ul.com" subject="IQA File Update - Corporate Webserver" from="Christopher.J.Nicastro">
File Upload to Corporate Server was successful! Information about the file is detailed below.

Content Type: #File.ContentType#
Content SubType: #File.ContentSubType#
Client Directory: #File.ClientDirectory#
Client File: #File.ClientFile#
Client FileName: #File.ClientFileName#
Client FileExt: #File.ClientFileExt#
Server Directory: #File.ServerDirectory#
...
File Was Renamed? #File.FileWasRenamed#
...
File Was Renamed? #File.FileWasRenamed#<br><br>

Notes: #Form.Notes#
<HR>
</CFOUTPUT>
<br>
Upload More? <a href="file_upload_admin.cfm">Do it again</a>.</p>
<cfelse>
...
<input name="Destination" type="Text" size="70" value="<cfoutput>#basedir#</cfoutput>">
<br><br>
Notes:<br>
