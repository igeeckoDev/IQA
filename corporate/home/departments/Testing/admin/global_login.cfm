...
<cfelseif finduser.status eq "removed">
	<cflocation url="global_login.cfm?msg=Account Deactivated. Please contact Kai Huang for more information." AddToken="No">
<cfelseif finduser.status eq "test">
	<cflocation url="global_login.cfm?msg=Test Accounts have been deactivated. Please contact Kai Huang if you have recieved this message in error." addtoken="No">
<cfelse>
...
Contact <a href="mailto:Kai.Huang@ul.com">Kai Huang</a> for further information.<br><br>
</cfif>
