...
<CFIF SESSION.Auth.accesslevel is "Admin" or SESSION.Auth.accesslevel is "SU" or SESSION.Auth.Accesslevel is "QRS">
                    ...
                    <td valign="top" class="content-column-left"> 
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
						  ...
						  <td class="blog-subtitle"><p align="left"><br>UL Offices</p></td>
                          <td></td>
						</tr>
						<tr> 
						  <td width="3%" height="20" align="right"></td>
...
&nbsp;&nbsp;&nbsp; - #OfficeName#<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
[<a href="contacts.cfm?ID=#ID#">Contacts</a>]<br>
