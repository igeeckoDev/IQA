...
<cfif getMonth.AuditedBy eq "IQA" AND getMonth.Year EQ 2014 AND getMonth.Month GTE 4
    ...
    <cfmail
        ...
        <a href="#request.serverProtocol##request.serverDomain#/departments/snk5212/IQA/getEmpNo.cfm?page=AuditSurvey&ID=#URL.ID#&year=#URL.Year#">#Form.SurveyBody#</a><br><br>
        ...
        If you have any questions or concerns please contact <a href="mailto:Kai.Huang@ul.com?Subject=#Form.SurveyBody#">Kai Huang</a><br /><br />
    </cfmail>
</cfif>
