...
<td class="blog-content" valign="top" align="center">#TwoYear#</td>
...
<cfloop from="#TwoYear#" to="#CurYear#" index="i">
...
<cfoutput query="Ex">
<cfif Comments is "">
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="rc_comments.cfm?TP=#URL.TP#">

<textarea WRAP="PHYSICAL" ROWS="4" COLS="60" NAME="Comments">No Comments</textarea><br><br>

<u>Watch List:</u><br>
<input type="Checkbox" name="Watch" value="1"> Check to add client to Watch List.<br><br>
...
<textarea WRAP="PHYSICAL" ROWS="4" COLS="60" NAME="Comments">#Comments#</textarea><br><br>

<u>Watch List:</u><br>
   <cfswitch expression="#Watch#">
  <cfcase value="1">
  <b><font color="red">On Watch List</font></b><br>
<input type="Checkbox" name="Watch" value="1" checked> Uncheck to remove client from Watch List.
  </cfcase>
  <cfcase value="0">
<input type="Checkbox" name="Watch" value="1"> Check to add client to Watch List.
  </cfcase>
  <cfcase value="">
<input type="Checkbox" name="Watch" value="1"> Check to add client to Watch List.
  </cfcase>
