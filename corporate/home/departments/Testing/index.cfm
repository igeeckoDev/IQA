...
<!--- Start of Page File --->
<CFSET SiteTitle='Corrective Action Request(CAR) Process'>

<cfinclude template="#SiteDir#SiteShared/StartOfPage.cfm">
<CFSET SiteTitle='Corrective Action Request(CAR) Process'>

The Quality department has responsibility for conducting audits of internal facilities, processes and programs/schemes. Internal audits are conducted
globally to provide insight into our operating effectiveness and compliance through the use of internal documentation, regulatory and accreditation
requirements.<br><br>

For any questions about this site or contents, please contact Kai Huang, who can be reached at extension
11536 or at <a href="mailto:kai.huang@ul.com">kai.huang@ul.com</a>.<br><br>
...
&nbsp; &nbsp; &nbsp; - <a href="select_auditor.cfm">View By Auditor</a> (Internal Audits Only)<br>
</td>
</tr>
</table>
</cfoutput>
