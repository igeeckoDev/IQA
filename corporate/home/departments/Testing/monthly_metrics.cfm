...
SELECT COUNT(*) as Count
 FROM AuditSchedule
 WHERE AuditType LIKE '%Quality System%' AND  Month = #LastMonth#
 AND YEAR_='2004' AND (Report IS NOT NULL OR NOT report = '')
<!--- DV_CORP_002 28-APR-09 Reconcilation 2 Change End--->
</cfquery>
...
Please view http://#CGI.SERVER_NAME#/departments/snk5212/IQA/metrics/monthly_metrics_view.cfm to view metrics for #monthAsString(month)#'s audits.
