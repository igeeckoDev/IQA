...
<cfif isDefined("SESSION.Auth.IsLoggedIn")>
	<cfoutput query="View" group="ID">
		<CFIF SESSION.Auth.accesslevel is "SU"
			...
			:: <a href="#IQARootDir#qReport_Output_All.cfm?#CGI.Query_String#" target="_blank">Print</a> Report<br>
...
<th align="center">Number of Findings</th>
<th align="center">Number of Observations</th>
<th align="Center">CAR/Audit Finding Number(s)*</th>
...
<table border="1" width="700" style="border-collapse: collapse;" style="font-family: verdana, arial, sans-serif; font-size: 11px;">
	<tr class="shade">
		<th width="30%">CAR/Audit Finding Number</td>
