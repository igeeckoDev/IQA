...
<a href="http://dap.us.ul.com:8300/DAPAuditorForm/faces/xxul_dap/projectAssoc/AuditorMainPage.jspx?userId=16963" target="_blank">DAP Scope Config Form</a><br><br>
...
<cflock scope="session" timeout="6">
	<cfif isDefined("SESSION.Auth.isLoggedIn")>
		<cfif SESSION.Auth.IsLoggedInApp eq "IQA">
			...
			<a href="http://dap.us.ul.com:8300/DAPAdminForms/faces/xxul_dap/projectAssoc/jspx/TestByStandards.jspx?userId=16963" target="_blank">Test by Standard Configuration</a><br><Br>
		</cfif>
	</cfif>
</cflock>
