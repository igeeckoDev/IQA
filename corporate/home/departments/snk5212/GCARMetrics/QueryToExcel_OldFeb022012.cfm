...
<cfif qRecordCount.CARCount GT 0 AND qRecordCount.CARCount lte 1650>

<!--- handle qGrouping.cfm query --->
<cfif isDefined("URL.Group") AND URL.Group eq "Yes" AND isDefined("URL.FullTable") AND URL.FullTable eq "Yes">
...
<td><b>CAR Clause</b></td>
<td><b>CAR Owner Reporting Location</b></td>
<!--- Add on 2/6/2012 on by uncommenting this section
