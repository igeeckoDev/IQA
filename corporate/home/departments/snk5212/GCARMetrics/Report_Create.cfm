...
<cfset subTitle = "CAR Trend Reports - Creating a Report">
...
AND ReportType = '#Form.ReportType#'
</cfquery>
...
<cflock scope="SESSION" timeout="6">
    ...
    INSERT INTO GCAR_METRICS_QREPORTS(ID, TopItems, Function, FunctionField, SortField, PostedDate, ReportType)
    VALUES(#getNewID.newID#, 5, '#url.Function#', '#url.FunctionField#', '#url.SortField#', #CreateODBCDate(PostedDate)#, '#form.ReportType#')
    </cfquery>
...
<cfelse>
	...
	WHERE employee_number = '#Form.ReportType#'
	</CFQUERY>
