...
<cfif isDefined("URL.Group") AND url.Group eq "Yes">
    ...
    SELECT groupName, groupType, ItemName, ExcludedType, ExcludedName, ExcludedType2, ExcludedName2
    ...
    <cfset newQuery = queryNew("RowID, ItemName, CountItem, ExcludedType, ExcludedName, ExcludedType2, ExcludedName2","Integer, VarChar, Integer, VarChar, VarChar, VarChar, VarChar")>
    ...
    <cfoutput query="getItems">
        ...
        <cfset querySetCell(newQuery, "ExcludedType", "#ExcludedType#")>
        <cfset querySetCell(newQuery, "ExcludedName", "#ExcludedName#")>
        <cfset querySetCell(newQuery, "ExcludedType2", "#ExcludedType2#")>
        <cfset querySetCell(newQuery, "ExcludedName2", "#ExcludedName2#")>
...
<cfelse>
    ...
    <cfquery name="getItems" datasource="UL06046"  username="#OracleDB_Username#" password="#OracleDB_Password#">
    <!--- Old: SELECT DISTINCT #url.var# as d#url.var# --->
    SELECT Count(docID) as Count, #url.var# as d#url.var#
    FROM GCAR_Metrics
    WHERE
    <cfinclude template="shared/incProgramQuery.cfm">
    <!--- url.var and url.varValue goes here on subsequent pages --->
