...
<cffunction name="onRequestStart" returnType="boolean" output="false">
	...
	<cfset Request.ErrorMailTo = "Global.InternalQuality@ul.com">

    <!--- Yes, this is intentionally a text field --->
    <cfset Request.contacts_CancelRescheduleAudits = "Global Internal Quality">
...
<!--- 2023+ --->
<cfset Request.IQAScope2023 = "1. The scope of the assessment includes verifying implementation of UL Solutions Compliance Policies, if applicable, and/or local Quality Management System Manual. Additional functional, local, scheme/program or process policies/procedures will also be utilized as required. Assessment to standard requirements (ISO/IEC 17065, ISO/IEC 17025, ISO/IEC 17020, ISO/IEC 17021, ISO 9001, SCC Requirements and Guidance � Product, Process, and Service Certification Body Accreditation Program, SCC Requirements and Guidance - Inspection Body and Accreditation Program, or equivalent standard) will be utilized as applicable. Specifics on the scope of this assessment are described in Attachment A.<Br><br>
...
<!--- local or lab audits --->
	<cfset Request.IQAScope_LocalOrLab = "1. The scope of the assessment includes verifying implementation of UL Solutions Compliance Policies, if applicable, and/or local Quality Management System Manual. Additional functional, local and or program policies/procedures will also be utilized.  Specifics on the scope
	of this assessment are described in Attachment A. These logistics will be addressed during pre-audit communications and/or during the Opening Sessions at each location.<br>
...
<cfif NOT isDefined("SESSION.Auth.IsLoggedIn")>
	<cfif curdir EQ IQAAdminDir OR curdir EQ IQAAccredLocationsDir>
		<cfif cgi.PATH_INFO NEQ "#IQAAdminDir#global_login.cfm"
			...
			<cfinclude template ="#IQAAdminDir#global_login.cfm">
			<cfabort>
		</cfif>
	</cfif>
</cfif>
