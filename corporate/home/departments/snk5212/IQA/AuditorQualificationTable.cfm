       ...
       <cfif isDefined("SESSION.Auth.isLoggedIn")>
           <cfif SESSION.Auth.AccessLevel eq "SU"
               ...
               <cfoutput>
                   ...
                   Go To <b><a href="#IQADir_Admin#_Quals.cfm">Admin View</a></b> (in order to edit this information on this page)<br /><br />
               </cfoutput>
           </cfif>
       </cfif>
   </cflock>
	...
	<cfoutput>
    	<cfloop query="Qualification">
    		<td bgcolor="CCCCCC" align="center">#QualificationName#<br><br>
				<a href="AuditorQualifications2.cfm?ID=#QualificationID#&Action=Qualification">
		           	View
	            </a>
			</td>
    	</cfloop>
