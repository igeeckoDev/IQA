...
<cfset subtitle = "<a href='Activity_Coverage_Menu.cfm'>Audit Activity, Coverage and Schedule Attainment</a><br> -
	...
	&nbsp; &nbsp; - Audit Type: <a href='metrics_new.cfm?AuditedBy=#URL.AuditedBy#&Year=#URL.Year#&AuditType2=#URL.AuditType2#'>#URL.AuditType2#</a><Br>
	&nbsp; &nbsp; &nbsp; &nbsp; - Area: #URL.Area#">
...
<tr>
	...
	SELECT COUNT(*) as Count, Year_, OfficeName
	FROM AuditSchedule
	...
	<tr>
		...
		<td align=left>
			#OfficeName#
			<cfif Audit.AuditArea eq "Certification Body (CB) Audit">
				<br><br>* Certification Body (CB) Audit
			</cfif>
		</td>
		<td align=center>
