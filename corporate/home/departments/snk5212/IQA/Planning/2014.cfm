...
<cfset subTitle = "2014 Audit Planning - Questions">
...
<cfform method ="post" id="myform" name="myform" action="2014_Submit.cfm?#CGI.QUERY_STRING#" enctype="multipart/form-data">
