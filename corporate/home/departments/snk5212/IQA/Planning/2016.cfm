...
<cfset subTitle = "2016 IQA Audit Planning - Questions">
...
<cfform method ="post" id="myform" name="myform" action="2016_Submit.cfm?#CGI.QUERY_STRING#" enctype="multipart/form-data">
