...
<cfset subTitle = "2016 IQA Audit Planning - Survey Results">
...
SELECT
    ...
    AuditPlanning2016_Users.SentTo,
    ...
    AuditPlanning2016_Users.SurveyFile
...
Please view the <a href="Distribution_2016.cfm?Type=Quality">Survey Distribution Lists</a> and respond with information about any Process, Program, or Site you are involved with.<br /><Br />
	...
	<cfif isDefined("SESSION.Auth")>
        <cfif SESSION.Auth.AccessLevel eq "SU" OR SESSION.Auth.AccessLevel eq "Admin">
            ...
            <cfif len(Output.SurveyFile)>
                ...
                :: <A href="2016_UploadFile.cfm?USERID=#URL.USERID#">Upload Replacement File</A>
            <cfelse>
                :: <A href="2016_UploadFile.cfm?USERID=#URL.USERID#">Upload File</A>
            </cfif><br /><br />
        </cfif>
    </cfif>
</cflock>
