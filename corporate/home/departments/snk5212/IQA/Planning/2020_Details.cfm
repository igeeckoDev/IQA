...
<cfset subTitle = "2020 IQA Audit Planning - Survey Results">
...
SELECT
	AuditPlanning2020_Answers.ID as aID,
	AuditPlanning2020_Answers.qID,
    AuditPlanning2020_Answers.Answer,
    AuditPlanning2020_Answers.Notes,
    AuditPlanning2020_Answers.ExtraField_Text as ExtraField_Text_Answer,
    AuditPlanning2020_Answers.ExtraField_FileName as ExtraField_FileName_Answer,
    AuditPlanning2020_Answers.ExtraField_CLOB as ExtraField_CLOB_Answer,

    AuditPlanning2020_Questions.Question,
    AuditPlanning2020_Questions.ID,
    AuditPlanning2020_Questions.ExtraField_Text,
    AuditPlanning2020_Questions.ExtraField_FileName,
    AuditPlanning2020_Questions.ExtraField_CLOB,

    AuditPlanning2020_Users.Type,
    AuditPlanning2020_Users.pID,
    AuditPlanning2020_Users.SentTo,
    AuditPlanning2020_Users.Posted,
    AuditPlanning2020_Users.PostedBy,
    AuditPlanning2020_Users.LaboratoryNames,
    AuditPlanning2020_Users.SurveyArea_Description,
    AuditPlanning2020_Users.SurveyFile,
	AuditPlanning2020_Users.SurveyType,
	AuditPlanning2020_Users.SurveyArea

FROM AuditPlanning2020_Answers, AuditPlanning2020_Questions, AuditPlanning2020_Users

WHERE
AuditPlanning2020_Users.ID = #URL.ID#
AND AuditPlanning2020_Answers.qID = AuditPlanning2020_Questions.ID
AND AuditPlanning2020_Answers.UserID = AuditPlanning2020_Users.ID
ORDER BY qID, aID
</CFQUERY>
...
<Cfoutput>
Please view the <a href="Distribution_2020.cfm?Type=#Output.SurveyType#">Survey Distribution Lists</a> and respond with information about any Process, Program, or Site you are involved with.<br /><Br />
</cfoutput>
