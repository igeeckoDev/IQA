...
<cfif URL.NewArea eq "Yes" AND URL.Type eq "New">
	...
	INSERT INTO AuditPlanning2021_Users(ID, Type, pID, SurveyType)
...
SELECT AuditPlanning2021_Questions.ID, AuditPlanning2021_Users.SurveyType
FROM AuditPlanning2021_Questions, AuditPlanning2021_Users
WHERE AuditPlanning2021_Users.ID = #NewUserID.NewID#
ORDER BY AuditPlanning2021_Questions.ID
</CFQUERY>
...
<cfdump var="#numQuestions#">
    ...
    <cfloop query="numQuestions">
        <cfif isDefined("#ID#_Answer")>
            ...
            SELECT ID FROM AuditPlanning2021_Answers
            </CFQUERY>
            ...
            <cfif CheckRows.RecordCount gte 1>
                ...
                SELECT MAX(ID)+1 as NewID
                FROM AuditPlanning2021_Answers
                </CFQUERY>
            <cfelse>
                <cfset NewID.NewID = 1>
            </cfif>
            ...
            <CFQUERY Name="AddRow" datasource="UL06046" username="#OracleDB_Username#" password="#OracleDB_Password#">
            INSERT INTO AuditPlanning2021_Answers(ID, qID, Answer, Notes, UserID)
            ...
            <cfif isDefined("#ID#_ExtraField_Text")>
           		<cfif len(Evaluate("Form.#ID#_ExtraField_Text"))>
                	 <CFQUERY Name="UpdateRow" datasource="UL06046" username="#OracleDB_Username#" password="#OracleDB_Password#">
                     UPDATE AuditPlanning2021_Answers
                     SET
...
<cflocation url="2021_Details.cfm?ID=#NewUserID.NewID#" addtoken="no">