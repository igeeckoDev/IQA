<!--- Start of Page File --->
<cfset subTitle = "Audit Request and Audit Planning Form - New Program/Process">
...
<CFQUERY Name="Rows" datasource="UL06046"  username="#OracleDB_Username#" password="#OracleDB_Password#">
INSERT INTO AuditPlanning2011(ID, Type, Posted, PostedBy)
VALUES(#NewID.NewID#, '#Form.Type#', #postDate#, '#Form.PostedInfo#')
</CFQUERY>
...
<cflocation url="AuditPlanning_New_Details_Review.cfm?ID=#NewID.NewID#" addtoken="No">
...
<cfif isDefined("Form.PostedBy")>
    ...
    <cfelse>
    	...
    	<cfset v_name = "Please Input Your Name">
      	<cfset qresult = 1>
    </cfif>
<cfelse>
	<cfset Form.PostedBy = "00000">
...
<cfform 
    ...
    width="650" 
    preservedata="yes"  
    Action="AuditPlanning_New_Details.cfm">

<b>Please Enter Program / Process Information Below</b><br /><br>
...
Enter the Program / Process Name:<br />
   	<cftextarea name="New_PName" cols="60" rows="1"></cftextarea>
</cfif><br><br>

<cfif NOT isDefined("URL.VS") AND NOT isDefined("URL.ULE")>
...
<cftextarea name="New_OwnerManager" cols="60" rows="3"></cftextarea><br><br>
...
2. Are there any new/pending accreditor requirements affecting your Program / Process?<br>
	<cfselect 
    	queryposition="below" 
...
3. IQA auditors are trained to ISO 17025, Guide 65, ISO 17021, ISO 17020, 510K requirements and ISO 9001. Are there any program specific training requirements that the auditor needs to complete to support your Program / Process? If so, who can provide the training?<br>
...
4. Are any major Program / Process documentation changes pending/planned?<br>
	<cfselect 
    	queryposition="below" 
