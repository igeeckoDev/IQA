...
<cfset subTitle = "IQA Audit Planning 2015 - #Type# Distribution List">
...
<cfif URL.Type eq "Laboratory">
	: <b>#Type#</b><br>
    : <a href="Distribution_2015.cfm?Type=Operations">Operations</a><br>
    : <a href="Distribution_2015.cfm?Type=Process">Process</a><br>
    : <a href="Distribution_2015.cfm?Type=Program">Program/Service/Offering</a><br>
    : <a href="Distribution_2015.cfm?Type=Quality">Responses from LQMs - Sites / New Programs, Processes, Sites, and Other Offerings</a><br>
    <!---: <a href="Distribution_2015.cfm?Type=New">New Program/Service/Offering</a>--->
<cfelseif URL.Type eq "Operations">
	: <a href="Distribution_2015.cfm?type=Laboratory">Laboratory</a><br>
    : <b>#Type#</b><br>
    : <a href="Distribution_2015.cfm?Type=Process">Process</a><br>
    : <a href="Distribution_2015.cfm?Type=Program">Program/Service/Offering</a><br>
    : <a href="Distribution_2015.cfm?Type=Quality">Responses from LQMs - Sites / New Programs, Processes, Sites, and Other Offerings</a><br>
...
<cfelseif URL.Type eq "New">
    ...
    : <a href="Distribution_2015.cfm?Type=Process">Process</a><br>
    : <a href="Distribution_2015.cfm?Type=Program">Program/Service/Offering</a><br>
    : <a href="Distribution_2015.cfm?Type=Quality">Local Quality Managers / Sites Outside Public Safety</a><br>
    : <b>#Type#</b>
--->
</cfif><br />
</cfoutput>
...
<cfif URL.Type eq "Program">
    ...
    SELECT AuditPlanning2015_Users.ID as ID, AuditPlanning2015_Users.SentTo as SentTo, AuditPlanning2015_Users.Responded, AuditPlanning2015_Users.SurveyType, AuditPlanning2015_Users.PostedBy, AuditPlanning2015_Users.Posted, AuditPlanning2015_Users.SentDate, AuditPlanning2015_Users.SurveyFile, Corporate.ProgDev.Program as Name
    FROM AuditPlanning2015_Users, Corporate.ProgDev
    WHERE AuditPlanning2015_Users.SurveyType = 'Program'
    AND AuditPlanning2015_Users.pID = Corporate.ProgDev.ID
    ORDER BY Corporate.ProgDev.Program, AuditPlanning2015_Users.Responded, AuditPlanning2015_Users.Posted DESC
    </CFQUERY>
<cfelseif URL.Type eq "Process">
	<CFQUERY BLOCKFACTOR="100" name="Distribution" Datasource="UL06046" username="#OracleDB_Username#" password="#OracleDB_Password#">
    SELECT AuditPlanning2015_Users.ID as ID, AuditPlanning2015_Users.SentTo as SentTo, AuditPlanning2015_Users.Responded, AuditPlanning2015_Users.SurveyType, AuditPlanning2015_Users.PostedBy, AuditPlanning2015_Users.Posted, AuditPlanning2015_Users.SentDate, AuditPlanning2015_Users.SurveyFile, Corporate.GlobalFunctions.Function as Name
    FROM AuditPlanning2015_Users, Corporate.GlobalFunctions
    WHERE AuditPlanning2015_Users.SurveyType = 'Process'
    AND AuditPlanning2015_Users.pID = Corporate.GlobalFunctions.ID
    ORDER BY Corporate.GlobalFunctions.Function, AuditPlanning2015_Users.Responded, AuditPlanning2015_Users.Posted DESC
    </CFQUERY>
       	...
       	<cfif Type neq "Laboratory" AND Type neq "Operations">
            ...
            <td valign="top" align="center">
                <cfif Responded eq "Yes">
                    <a href="2015_Details.cfm?UserID=#ID#">View</a>
                <cfelse>
                    --
                </cfif>
            </td>
...
<tr>
	<td valign="top">Peter Johnston</td>
    <Td valign="top">Peter.Johnston@ul.com </Td>
    <Td valign="top">New Zealand</Td>
    <td valign="top">2014-12-3</td>
</tr>
<tr>
	<td valign="top">Francisco Martinez</td>
    <Td valign="top">Francisco.Martinez@ul.com</Td>
    <Td valign="top">DEWI Wilhelmshaven</Td>
    <td valign="top">2014-12-3</td>
</tr>
