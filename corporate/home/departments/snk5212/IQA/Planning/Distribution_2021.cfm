...
<cfset subTitle = "IQA Audit Planning 2021 - #Type# List">
...
<u>Currently Viewing:</u><br />
	<cfif URL.Type eq "Certification Body">
		: <a href="Distribution_2021.cfm?Type=Process">Process</a><br>
		: <b>#Type#</b><br>
		: <a href="Distribution_2021.cfm?Type=Program">Program/Service/Offering</a><br>
		: <a href="Distribution_2021.cfm?Type=Quality">Site Related (Engineering, Laboratory, Quality, Accreditation, etc)</a><br>
		: <a href="Distribution_2021.cfm?Type=New Area">New Area</a><br>
	<cfelseif URL.Type eq "Process">
		: <b>#Type#</b><br>
		: <a href="Distribution_2021.cfm?Type=Certification Body">Certification Body</a><br>
		: <a href="Distribution_2021.cfm?Type=Program">Program/Service/Offering</a><br>
		: <a href="Distribution_2021.cfm?Type=Quality">Site Related (Engineering, Laboratory, Quality, Accreditation, etc)</a><br>
		: <a href="Distribution_2021.cfm?Type=New Area">New Area</a><br>
	<cfelseif URL.Type eq "Program">
...
<cfoutput>
	...
	:: <A href="2021.cfm?NewArea=Yes&Type=New">Open Survey for a New Area</A><br /><br />
</cfoutput>
		...
		<tr>
			...
			<td valign="top" align="left">
				...
				<cfif URL.Type eq "New Area">
					<a href="2021_Details.cfm?ID=#ID#">View Survey</a><br>
				...
				<cfelse>
					...
					<cfif Responses.recordCount GT 0>
						<cfloop query="Responses">
							<a href="2021_Details.cfm?ID=#SurveyID#">View Survey</a><br>
			...
			<cfif URL.Type neq "New Area">
				<td valign="top" align="center">
					<A href="2021.cfm?ID=#ID#&Type=#URL.Type#&NewArea=No"><img src="../../SiteImages/ico_article.gif" border="0" /></A>
				</td>
			<cfelseif URL.Type eq "New Area">
				<td>
