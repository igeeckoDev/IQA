...
SELECT AuditPlanning2017_Users.ID as ID, AuditPlanning2017_Users.SentTo as SentTo, AuditPlanning2017_Users.Responded, AuditPlanning2017_Users.SurveyType, AuditPlanning2017_Users.PostedBy, AuditPlanning2017_Users.Posted, Corporate.GlobalFunctions.Function as Name
FROM AuditPlanning2017_Users, Corporate.GlobalFunctions
WHERE AuditPlanning2017_Users.Type = 'Process'
...
<a href="#request.serverProtocol##request.serverDomain#/departments/snk5212/IQA/Planning/Distribution_2017.cfm?Type=Process">#request.serverProtocol##request.serverDomain#/departments/snk5212/IQA/Planning/Distribution_2017.cfm?Type=Process</a><br /><br />
...
<u>Note</u> - You will receive this email for each Scheme/Program or Process where you are the Owner or Manager.<br><br>
