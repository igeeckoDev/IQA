...
Subject: Quality System Audit of <b>[OfficeName] - [AuditArea]</b><br><br>

Dear <b>[Name]</b>,<br><br>

This is to confirm our communications pertaining to the<cfif desk is "Yes"> desk</cfif> audit of UL <b>[OfficeName] - [AuditArea]</b> that is scheduled for <b>[Start Date]</b>. <b>[Lead Auditor]</b> will conduct this audit, which will begin with an opening session to review the audit scope and coordinate audit activities with you and your staff. <b>[Auditor]</b> will be assisting on this audit.<br><br>
...
All Noncompliance and Preventive actions noted during the audit will be discussed with you during a<cfif Desk is "No"> formal</cfif> closing session on <b>[End Date]</b>.<br><br>
