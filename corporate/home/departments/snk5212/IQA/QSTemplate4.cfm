...
All Noncompliance and Preventive actions noted during the audit will be discussed with you during a<cfif Desk is "No"> formal</cfif> closing session on <B>#DateFormat(EndDate, 'mmmm dd, yyyy')#</B>.<br><br>
