...
This is to confirm our communications pertaining to the<cfif desk is "Yes"> desk</cfif> audit of the <b>#OfficeName# - #Area#</b> program operations scheduled to begin on <B>#DateFormat(StartDate, 'mmmm dd, yyyy')#</B>. The audit will conclude on <B>#DateFormat(EndDate, 'mmmm dd, yyyy')#</b>. <cfif Aud is "" or Aud is "- None -"><cfelse><b>#Aud#</b> will be assisting on this audit.</cfif><br><br>
