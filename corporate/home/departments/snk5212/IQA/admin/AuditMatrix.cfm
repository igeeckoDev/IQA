...
<table border="1" width="1000" style="border-collapse: collapse;">
	...
	<tr>
		<th colspan="9" align="left">#MonthAsString(Month)#</th>
	</tr>
	</cfif>

	<tr valign="top">
		<td>
			<A href="AuditDetails.cfm?Year=#Year_#&ID=#ID#">#Year_#-#ID#-IQA</a>
		</td>
		<td>
		...
		<td>
			<cfif auditArea is "Certification Body (CB) Audit">
				<u>Legal Entity / Certification Body</u>
				<br>#OfficeName#
			<cfelse>
				#OfficeName#
			</cfif>
		...
		<td>
			...
			<cfif auditArea is "Scheme Documentation Audit">
				...
				<cfif NOT len(Status)>
					<br><br>
					<u>Legal Entity / Certification Body</u><br>
		...
		<td>
			...
			<cfif len(AuditorInTraining)>
				<cfif AuditorInTraining neq "- None -">
					<u>Auditor(s) In Training</u><Br>- #replace(AuditorInTraining, ",", "<br>- ", "All")#<br><Br>
				</cfif>
			</cfif>
			<cfif len(SME)>
		...
		<td width="150">
			<CFIF SESSION.Auth.accesslevel is "SU"
				...
				:: <a href="AuditMatrix_Edit.cfm?auditID=#xGUID#&Year=#URl.Year#">Edit</a><br>
			</cfif>

			:: <A href="AuditDetails.cfm?Year=#Year_#&ID=#ID#">Audit Details</a><br>
			...
			<!--- Status --->
			<cfinclude template="#IQADir#status_colors_matrix.cfm"><Br><br>
