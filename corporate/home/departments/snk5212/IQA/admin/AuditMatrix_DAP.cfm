...
<table border="1" width="1000" style="border-collapse: collapse;">
	...
	<tr valign="top">
		...
		<td width="150">
			...
			<!--- Status --->
			<br>
			<cfinclude template="#IQADir#status_colors_AS.cfm">

			<cfif len(Notes)><Br><br><u>Notes</u>:<br>#Notes#</cfif>

			<cfif len(AdminNotes)><Br><br><u>Admin Notes</u>:<br>#AdminNotes#</cfif>
		</td>
	</tr>
