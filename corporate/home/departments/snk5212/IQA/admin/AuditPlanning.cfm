...
<cfset endYear = curyear + 1>
	<cfloop from=2015 to=2025 index=i>
...
<b><font class="warning">Add Audit</font></b> - <a href="addaudit.cfm?AuditedBy=IQA" target="_blank">Add Audit</a> - <font class="warning">This link will take you out of the planning module. Audits are added to the schedule, and are replicated to the Planning List.</font><br><br>
</cfoutput>
...
<table border="1" width="1000">
	...
	<tr valign="top">
		<td>#Year_#-#ID#-IQA<br><br>

			<cfif Desk is "Yes">Desk Audit<br><br><cfelseif Desk is "Blended">Blended Audit<br><br><cfelseif Desk is "No">On-site Audit<br><br></cfif>
		...
		<td width="150">
			<cfif len(Status.ReadyToPublish) AND Status.ReadytoPublish is "Yes"
				...
				<cflock scope="SESSION" timeout="60">
					<cfif SESSION.Auth.UserName eq "Chris" or SESSION.Auth.Username eq "Superuser" or SESSION.Auth.Username eq "Pmouawad">
						<br>
			...
			<cfelse>
				<cflock scope="SESSION" timeout="60">
					<CFIF SESSION.Auth.accesslevel is "SU" 
						...
						OR SESSION.Auth.UserName eq "Li"
						OR SESSION.Auth.UserName eq "Ip"
						OR SESSION.Auth.UserName eq "Ip_RQM"
						OR SESSION.Auth.UserName eq "Mouawad"
						OR SESSION.Auth.UserName eq "Niklewicz"
						OR SESSION.Auth.UserName eq "GCheevers">
