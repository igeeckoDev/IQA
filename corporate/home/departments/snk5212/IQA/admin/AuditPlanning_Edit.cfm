...
<tr valign="top">
	...
	<td>
		<cfswitch expression="#Desk#">
			<cfcase value="Yes"><!--- Remote --->
				Remote <INPUT TYPE="Radio" name="Desk" value="Yes" checked> Blended <INPUT TYPE="Radio" name="Desk" value="Blended"> On-site <INPUT TYPE="Radio" name="Desk" value="No">
			</cfcase>
			<cfcase value="No"><!--- onsite --->
				Remote <INPUT TYPE="Radio" name="Desk" value="Yes"> Blended <INPUT TYPE="Radio" name="Desk" value="Blended"> On-Site <INPUT TYPE="Radio" name="Desk" value="No" checked>
			</cfcase>
			<cfcase value="Blended"><!--- blended --->
				Remote <INPUT TYPE="Radio" name="Desk" value="Yes"> Blended <INPUT TYPE="Radio" name="Desk" value="Blended" checked> On-Site <INPUT TYPE="Radio" name="Desk" value="No">
			</cfcase>
			<cfcase value="">
				Remote <INPUT TYPE="Radio" name="Desk" value="Yes"> Blended <INPUT TYPE="Radio" name="Desk" value="Blended"> On-site <INPUT TYPE="Radio" name="Desk" value="No">
			</cfcase>
		</cfswitch>
	</td>
	</tr>
