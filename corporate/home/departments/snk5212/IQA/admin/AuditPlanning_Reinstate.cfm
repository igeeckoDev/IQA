...
<cfset subTitle = "<a href='AuditPlanning.cfm?Year=#URL.year#'>#URL.Year# Audit Planning</a> - Reinstate Audit">
...
<cfelse>
	...
	Are you are you want to reintate this audit?<br><br>
	...
	<input type="Submit" name="Submit" value="Reinstate this Audit to the Planning Module">
	</form>
	</cfoutput>
</cfif>
