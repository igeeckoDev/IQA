...
<!---
	...
	Scheduler = '<u>Username:</u> System (Superuser) - #historyYear# Audit Planning Published to #historyYear# Audit Schedule<br><u>Time:</u> #curdate#'
