...
<cfif Bob is "Field Services">
<cflocation URL="FUSSummary.cfm?Year=#CurYear#" ADDTOKEN="No">
</cfif>

<CFQUERY BLOCKFACTOR="100" name="Summary" Datasource="Corporate">
SELECT * FROM AuditSchedule
<CFif Bob is "AS" or Bob is "QRS">
WHERE AuditedBy = '#Bob#'
<cfelse>
...
<CFIF Bob is "Quality System" or Bob is "Technical Assessment">
ORDER BY OfficeName, Month DESC, StartDate DESC, EndDate DESC
<CFELSEif Bob is "AS" or Bob is "QRS">
ORDER BY AuditType, Month DESC, StartDate DESC, EndDate DESC, OfficeName
<cfelse>
ORDER BY ExternalLocation, Month DESC, StartDate DESC, EndDate DESC
</CFIF>
</CFQUERY>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          ...
                          <td width="94%" align="left" class="blog-title"><p align="left"><br>
                              Audit Summary - <cfoutput>#Bob#</cfoutput></p></td>
...
<p align="left">#LastYear# <a href="AuditTypeSummary.cfm?Year=#CurYear#&AuditType=#Bob#">[ #CurYear# ]</a> <a href="AuditTypeSummary.cfm?Year=#NextYear#&AuditType=#Bob#">[ #NextYear# ]</a><br><br>
<cfelseif URL.Year is CurYear>
<p align="left"><a href="AuditTypeSummary.cfm?Year=#LastYear#&AuditType=#Bob#">[ #LastYear# ]</a> #CurYear# <a href="AuditTypeSummary.cfm?Year=#NextYear#&AuditType=#Bob#">[ #NextYear# ]</a><br><br>
<cfelseif URL.Year is NextYear>
<p align="left"><a href="AuditTypeSummary.cfm?Year=#LastYear#&AuditType=#Bob#">[ #LastYear# ]</a> <a href="AuditTypeSummary.cfm?Year=#CurYear#&AuditType=#Bob#">[ #CurYear# ]</a> #NextYear# <br><br>
<cfelse>
</cfif>
</CFOUTPUT>

<CFIF Bob is "SMT">
<p>Please select another type of Audit. SMT audits are not tracked in this schedule currently.</p>
	<CFELSEIF Bob is "Quality System" or Bob is "Technical Assessment" or Bob is "Quality System,Technical Assessment" or Bob is "Quality System, Technical Assessment">
...
<CFOUTPUT query="Summary">
<cfif ExHolder IS NOT ExternalLocation> 
<cfIf ExHolder is NOT ""><br></cfif>
<b>#ExternalLocation#</b><br> 
</cfif>
...
<cfset ExHolder = ExternalLocation> 
</CFOUTPUT>
...
<CFOUTPUT query="Summary">
<cfif ASHolder IS NOT AuditType> 
<cfIf ASHolder is NOT ""><br></cfif>
<b>#AuditType#</b><br> 
</cfif>

<b><a href="AuditDetails.cfm?ID=#ID#&Year=#Year#">#AuditedBy#-#Year#-#ID#</a></b> #OfficeName#  - <cfset CompareDate = Compare(StartDate, EndDate)>
