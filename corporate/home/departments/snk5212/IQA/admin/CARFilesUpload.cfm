...
<cfoutput>
	<cfif Files.CategoryID eq 14>
		<cfmail to="Mark.D.Jessen@ul.com" From="do_not_reply_IQA@ul.com" subject="Auditor In Training Form Updated">
		AIT Form named "#files.FileLabel#" has been uploaded to the IQA Site by #SESSION.Auth.Name#.
		</cfmail>
	</cfif>
</cfoutput>

<cfif Files.CategoryID eq 14 OR Files.CategoryID eq 15>
	<cflocation url="AuditorInTrainingRecords.cfm" addtoken="No">
<cfelse>
	<cflocation url="ViewFiles.cfm?CategoryID=#Files.CategoryID#" addtoken="No">
</cfif>
...
Revision Date: #dateformat(RevDate, "mm/dd/yyyy")#<br>
Revision Author: #RevAuthor#<br>
<cfif RevNo is NOT Files2.MaxRev>
File: <a href="#CARRootPath#QEFiles\Doc#DocNumber#Rev#RevNo#.#FileType#">View</a><br>
<cfelse>
File: <a href="#CARRootPath#QEFiles\Doc#DocNumber#Current.#FileType#">View</a><br>
</cfif>
