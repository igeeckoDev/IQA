...
AND AuditType NOT LIKE '%Technical Assessment%'
AND Approved = 'Yes'
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          ...
                          <td width="94%" align="left" class="blog-title"><p align="left"><br>
                              Audit Summary - Audits Completed
</p><br></td>
...
<CFOUTPUT query="Summary">						  
	<CFIF Report is not "">
		<CFIF ExternalLocation is "- None -">
			<li><b><a href="AuditDetails.cfm?ID=#ID#&Year=#Year#">#Year#-#ID#-#AuditedBy#</a></b> - #OfficeName#<cfif AuditArea is ""><cfelse> (#TRIM(AuditArea)#)</cfif>, #AuditType#, <cfset CompareDate = Compare(StartDate, EndDate)>
...
<cfelse>
	...
	#DateFormat(Start, 'mmmm dd')# - #DateFormat(End, 'mmmm dd, yyyy')#
		...
		<CFELSEIF OfficeName is "- None -">
			<li><b><a href="AuditDetails.cfm?ID=#ID#&Year=#Year#">#Year#-#ID#</a></b> - #ExternalLocation# - #AuditType#, <cfset CompareDate = Compare(StartDate, EndDate)>
