...
<td>#ID#</td>
	...
	<td>#ResultsSent#</td></td>
	<td>Results Sent (#dateformat(ResultsSentDate, 'mm/dd/yyyy')#)</td>
	<td>#RequiresReviewComments#</td>
	<td>#dateformat(RequiresReview_CompletedDate, 'mm/dd/yyyy')#<br>#RequiresReview_CompletedName#</td>
	<td>#DAPScopeReviews#</td>
	<td>#DAPScopeReviews_Comments#</td>
</tr>" addnewline="yes">
</cfoutput>
