...
<tr class="blog-content" align="left" valign="top">
	...
	<cfif Month lte 6>
		...
		<td align="center">
			...
			<CFQUERY BLOCKFACTOR="100" name="Complete" Datasource="UL06046_IN" username="#OracleDB_Username#" password="#OracleDB_Password#">
			...
			<CFQUERY BLOCKFACTOR="100" name="Entered" Datasource="UL06046_IN" username="#OracleDB_Username#" password="#OracleDB_Password#">
			SELECT Status FROM xSNAPDATA
			WHERE AuditID = #ID#
			AND AuditYear = #Year_#
			AND AuditOfficeNameID = #Locations.OfficeID#
