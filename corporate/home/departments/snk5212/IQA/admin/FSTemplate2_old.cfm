...
This is to confirm our communications pertaining to the audit of UL <b>[OfficeName - Area]</b> that is scheduled for <B>[Start Date]</B>. <B>[Lead Auditor]</B> of UL's Corporate Quality Assurance Department will conduct this audit. [Auditor] will be assisting on this audit.<br><br>

I plan to arrive at <b>[OfficeName - Area]</b> at <b>[Start Time]</b> and begin the assessment with an opening session to review the audit scope and coordinate audit activities with you and your staff. <br><br>
...
All Noncompliance and Preventive actions noted during the audit will be discussed with you during a formal closing session anticipated for the afternoon of <B>[End Date]</B>.<br><br>
