...
This is to confirm our communications pertaining to the audit of UL <b>#OfficeName# - #Area#</b> that is scheduled for <B>#DateFormat(StartDate, 'mmmm dd, yyyy')#</B>. <B>#LeadAuditor#</B> of UL's Corporate Quality Assurance Department will conduct this audit. <cfif Auditor is "" or Auditor is "- None -"><cfelse>#Auditor# will be assisting on this audit.</cfif><br><br> 

I plan to arrive at <b>#OfficeName# - #Area#</b> at <b>#TimeFormat(StartTime, "h:mm tt")#</b> and begin the assessment with an opening session to review the audit scope and coordinate audit activities with you and your staff. <br><br>
...
The scope of this audit is described in Attachment A.  This visit will focus on areas of the Field Services Manual, and other supporting documents.<br><br>
...
All Noncompliance and Preventive actions noted during the audit will be discussed with you during a formal closing session anticipated for the afternoon of <B>#DateFormat(EndDate, 'mmmm dd, yyyy')#</B>.<br><br>
