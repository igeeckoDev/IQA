...
This is to confirm our communications pertaining to the<cfif desk is "Yes"> desk</cfif> audit of UL <B>#OfficeName# - #Area#</B> that is scheduled for <B>#DateFormat(StartDate, 'mmmm dd, yyyy')#</B>. <B>#LeadAuditor#</B> will conduct this audit, which will begin with an opening session to review the audit scope and coordinate audit activities with you and your staff. <cfif Aud is "" or Aud is "- None -"><cfelse><b>#Aud#</b> will be assisting on this audit.</cfif><br><br>
...
All Noncompliance and Preventive actions noted during the audit will be discussed with you during a formal closing session on <B><cfif Form.EndDate is "" or Form.EndDate eq Form.StartDate>#DateFormat(Form.StartDate, 'mmmm dd, yyyy')#<cfelse>#DateFormat(Form.EndDate, 'mmmm dd, yyyy')#</cfif></B>.<br><br></cfif>
