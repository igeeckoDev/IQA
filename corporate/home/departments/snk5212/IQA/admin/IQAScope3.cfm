...
A closing meeting will be scheduled at the completion of the audit to discuss any Noncompliance and Preventive actions noted during the audit.<cfelse>

All Noncompliance and Preventive actions noted during the audit will be discussed with you during a formal closing session on <cfif EndDate is "" or EndDate eq StartDate>#DateFormat(StartDate, 'mmmm dd, yyyy')#<cfelse>#DateFormat(EndDate, 'mmmm dd, yyyy')#</cfif>.</cfif>
