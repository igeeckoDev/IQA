...
All Noncompliance and Preventive actions noted during the audit will be discussed with you during a formal closing session on <B><cfif EndDate is "" or EndDate eq StartDate>#DateFormat(StartDate, 'mmmm dd, yyyy')#<cfelse>#DateFormat(EndDate, 'mmmm dd, yyyy')#</cfif></B>.<br><br></cfif>
