...
<cfset subTitle = "Laboratory Technical Audit - Edit Audit #URL.Year#-#URL.ID#">
...
<cfoutput>					  
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="LTA_EditAudit_Submit.cfm?#CGI.QUERY_STRING#">
</cfoutput>
