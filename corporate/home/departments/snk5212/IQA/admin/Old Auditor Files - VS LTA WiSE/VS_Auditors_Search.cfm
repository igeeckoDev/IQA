...
<cfset subTitle = "Verification Services - Add Auditors - Search Results">
...
<cfelseif qresult eq 1>
	Results:<br>
	<cfoutput>
	- #v_name#, #Location# (#v_email#) <a href="VS_Auditors_Add.cfm?Auditor=#v_name#&Email=#v_Email#&Location=#Location#">[select]</a><br>
	</cfoutput>
<cfelseif qresult eq 2>
	...
	<td class="blog-content"><a href="VS_Auditors_Add.cfm?Auditor=#first_n_middle# #last_name#&Email=#employee_email#&Location=#Location_code#">Add Auditor</a></td>
	</tr>
	</cfoutput>
	</table>
</cfif>
