...
<cfoutput query="Auditors">
    <cfif Form.Auditor is "#Auditor#">
        <cflocation url="WiSE_Auditors.cfm?msg=duplicate&id=#ID#" addtoken="no">
    </cfif>
</cfoutput>
...
<cflocation url="WiSE_Auditors.cfm?Auditor=#Form.Auditor#&msg=added&ID=#ID.newid#" addtoken="no">