...
SELECT AuditSchedule.*, AuditSchedule.Year_ AS Year, AuditSchedule.ScopeLetter, AuditSchedule.AuditedBy, AuditSchedule.Month
FROM AuditSchedule
WHERE ID = #URL.ID#
...
<textarea WRAP="PHYSICAL" ROWS="5" COLS="70" NAME="OFIs" displayname="Opportunities for Improvement (OFI)">Please enter any OFIs</textarea><br><br>
</cfif>
</cfoutput>
...
<td align="center"><INPUT TYPE="TEXT" NAME="e_Count#alpha#" displayname="#KP# #NCTitle#" VALUE="0" size="3"></td>
<td align="center"><INPUT TYPE="TEXT" NAME="e_OCount#alpha#" displayname="#KP# #PATitle#" VALUE="0" size="3"></td>
<Td><Input Type="Text" Name="e_CAR#alpha#" Value="0" displayname="#KP# #RefTitle#" size="25"></td>
<cfif Audit.Year gte 2010>
...
<cfif Audit.Year is 2007>
	...
	<td align="center"><INPUT TYPE="TEXT" NAME="e_CountOther" displayname="Other - #NCTitle#" VALUE="0" size="3" onChange="return numbers()"></td>
	<td align="center"><INPUT TYPE="TEXT" NAME="e_OCountOther" displayname="Other - #PATitle#" VALUE="0" size="3" onChange="return numbers()"></td>
	<Td><Input Type="Text" Name="e_CAROther" Value="0" displayname="Other - #RefTitle#" size="25" onChange="return numberlist()"></td>
	</tr>
	</cfif>
