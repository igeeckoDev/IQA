<CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="check">
...
<cfif Audit.Year is 2008>
	<cfif Audit.Month gte 9>
        <CFQUERY BLOCKFACTOR="100" NAME="Sector" DataSource="Corporate2">
        SELECT *
...
<cfif Audit.Year is 2007>
	<cfif Audit.Month gte 9>
		<CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="qKP">
...
<cfelseif Audit.Year gte 2010>
	...
	<cfelseif Audit.Year gte 2011>
		...
		<CFQUERY BLOCKFACTOR="100" Datasource="UL06046_IN" NAME="qKP">
...
<CFQUERY name="Programs" Datasource="Corporate2">
...
<cflock scope="SESSION" timeout="60">
	<cfif SESSION.Auth.accesslevel is "RQM">
        <CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="Offices">
...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ID="Audit" ACTION="Report2T2.cfm?ID=#ID#&Year=#Year#&AuditedBy=#AuditedBy#">
