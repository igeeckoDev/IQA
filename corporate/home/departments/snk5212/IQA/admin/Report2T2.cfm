...
<cfif Check.AuditedBy eq "IQA">
	<cfif Check.year GTE 2015>
		<CFQUERY BLOCKFACTOR="100" name="Time" Datasource="UL06046_IN" username="#OracleDB_Username#" password="#OracleDB_Password#">
...
<CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="a">
...
<cfif a.recordcount is 0>
    <CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="FirstEntry">
    ...
    <CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="fus">
	...
	<cfif fus.AuditType2 is "Field Services">
        <CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="fus2">
        SELECT ID, YEAR_ as "Year"
        FROM Report5
        WHERE ID = #URL.ID#
        AND Year_ = <cfqueryparam value="#URL.Year#" cfsqltype="cf_sql_integer">
...
<CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="Queryadd">
UPDATE Report
SET
...
<CFQUERY BLOCKFACTOR="100" Datasource="Corporate2" NAME="KP">
SELECT * FROM KP
ORDER BY Alpha
</cfquery>
