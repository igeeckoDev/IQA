...
<cfif Audit.Year is 2008>
	...
	<CFQUERY BLOCKFACTOR="100" NAME="Sector" DataSource="Corprate">
SELECT *
...
<cfoutput query="View">
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="Report_Edit2New.cfm?#CGI.QUERY_STRING#">
...
<textarea WRAP="PHYSICAL" ROWS="8" COLS="90" NAME="OFIs" displayname="Opportunities for Improvement (OFI)">#OFIs# </textarea><br><br>
</cfif>
...
<CFSET var2[38][1] = 'CAR38'>
<CFSET var2[39][1] = 'CAR39'>
<CFSET var2[40][1] = 'CAR40'>
<CFSET var2[41][1] = 'CAR41'>
<CFSET var2[42][1] = 'CAR42'>
<CFSET var2[43][1] = 'CAR43'>
<CFSET var2[44][1] = 'CAR44'>
<CFSET var2[45][1] = 'CAR45'>
...
<CFSET var2[38][2] = 'Count38'>
<CFSET var2[39][2] = 'Count39'>
<CFSET var2[40][2] = 'Count40'>
<CFSET var2[41][2] = 'Count41'>
<CFSET var2[42][2] = 'Count42'>
<CFSET var2[43][2] = 'Count43'>
<CFSET var2[44][2] = 'Count44'>
<CFSET var2[45][2] = 'Count45'>
...
<cfif Audit.Year gte 2019>
<CFSET var3[38][1] = '#OCount38#'>
<CFSET var3[39][1] = '#OCount39#'>
<CFSET var3[40][1] = '#OCount40#'>
<CFSET var3[41][1] = '#OCount41#'>
<CFSET var3[42][1] = '#OCount42#'>
<CFSET var3[43][1] = '#OCount43#'>
<CFSET var3[44][1] = '#OCount44#'>
<CFSET var3[45][1] = '#OCount45#'>
</cfif>
...
<CFSET var3[38][2] = 'OCount38'>
<CFSET var3[39][2] = 'OCount39'>
<CFSET var3[40][2] = 'OCount40'>
<CFSET var3[41][2] = 'OCount41'>
<CFSET var3[42][2] = 'OCount42'>
<CFSET var3[43][2] = 'OCount43'>
<CFSET var3[44][2] = 'OCount44'>
<CFSET var3[45][2] = 'OCount45'>
</cfoutput>
...
<cfif Audit.Year gte 2019>
<CFSET varSR[38][1] = '#SR38#'>
<CFSET varSR[39][1] = '#SR39#'>
<CFSET varSR[40][1] = '#SR40#'>
<CFSET varSR[41][1] = '#SR41#'>
<CFSET varSR[42][1] = '#SR42#'>
<CFSET varSR[43][1] = '#SR43#'>
<CFSET varSR[44][1] = '#SR44#'>
<CFSET varSR[45][1] = '#SR45#'>
</cfif>
<CFSET varSR[1][2] = 'SR1'>
<CFSET varSR[2][2] = 'SR2'>
<CFSET varSR[3][2] = 'SR3'>
...
<CFSET varSR[38][2] = 'SR38'>
<CFSET varSR[39][2] = 'SR39'>
<CFSET varSR[40][2] = 'SR40'>
<CFSET varSR[41][2] = 'SR41'>
<CFSET varSR[42][2] = 'SR42'>
<CFSET varSR[43][2] = 'SR43'>
<CFSET varSR[44][2] = 'SR44'>
<CFSET varSR[45][2] = 'SR45'>
...
<CFSET i=#ID#>
	<tr>
	<td>#Title#</td>
<td class="blog-content" valign="top" align="center"><input type="text" name="e_#var2[i][2]#" value="#var[i][3][3]#" size="3" ></td>
<td class="blog-content" valign="top" align="center"><input type="text" name="e_#var3[i][2]#" value="#var3[i][1]#" size="3"></td>
<Td class="blog-content" align="center"><input type="text" name="e_#var2[i][1]#" value="#var[i][2][2]#" size="25"></td>
	<Td class="blog-content" align="center"><input type="text" name="e_#varSR[i][2]#" value="#varSR[i][1]#" size="25" ></td>
...
<td class="blog-content" valign="top" align="center"><input type="text" name="e_#var2[i][2]#" value="#var[i][3][3]#" size="3" displayname="#var[i][1][1]# #NCTitle#" validate="integer" message="#var[i][1][1]# #NCTitle# - Please Enter a Number"></td>
<td class="blog-content" valign="top" align="center"><input type="text" name="e_#var3[i][2]#" value="#var3[i][1]#" size="3" displayname="#var[i][1][1]# #PATitle#" validate="integer" message="#var[i][1][1]# #PATitle# - Please Enter a Number"></td>
<Td class="blog-content" align="center"><input type="text" name="e_#var2[i][1]#" value="#var[i][2][2]#" size="25" displayname="#var[i][1][1]# #RefTitle#"></td>
</tr>
</cfoutput>
</CFloop>
...
<td class="blog-content" valign="top" align="center"><input type="text" name="e_#var2[i][2]#" value="#var[i][3][3]#" size="3" displayname="#varNew[i][1][1]# #NCTitle#" validate="integer" message="#varNew[i][1][1]# #NCTitle# - Please Enter a Number"></td>
<td class="blog-content" valign="top" align="center"><input type="text" name="e_#var3[i][2]#" value="#var3[i][1]#" size="3" displayname="#varNew[i][1][1]# #PATitle#" validate="integer" message="#varNew[i][1][1]# #PATitle# - Please Enter a Number"></td>
<Td class="blog-content" align="center"><input type="text" name="e_#var2[i][1]#" value="#var[i][2][2]#" size="25" displayname="#varNew[i][1][1]# #RefTitle#"></td>
</tr>
</cfoutput>
</CFloop>
	</cfif>
