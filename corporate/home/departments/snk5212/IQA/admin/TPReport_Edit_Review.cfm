...
<cfif link is "http://#CGI.Server_Name##curdir#TPReport_edit6.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">
...
<cfelseif link is "http://#CGI.Server_Name##curdir#TPReport_edit5.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          ...
                          <td width="94%" align="left" class="blog-title"><p align="left"><br>
                              Full Audit Report <cfoutput>#Year#-#ID#-#AuditedBy#</cfoutput></p><br></td>
...
<cfif col is "Year" or col is "ID" or col is "Comments">
<cfelse>
 <cfoutput query="outputfs" maxrows="14">
<tr><td class="blog-content">
