...
SELECT TPReport.ID, TPREPORT.YEAR_ as "Year", TPReport.Year_, TPReport.Recommend, Recommend.ID, Recommend.Recommend, Recommend.Text
...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=450,height=275,left = 200,top = 200');");
}
-->
</script>
...
:: <a href="TPReport_Print.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">Print</a> Report<br>
:: <a href="TPReport_Print_All.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">Print</a> Report (for Auditors' Reference)<br>
<cfif Report is "Completed">
:: Report Published<br><br>
<b>* To 'Print to PDF'</b><br>
- Click 'Print Report' above
- Choose File -> Print in the browser menu<br>
- Select PDF Writer or Adobe Acrobat PDF or similar PDF option<br>
- Select 'Print'<br>
- The TP Report will be output to a PDF File, saved to your computer.<br>
<cfelse>
:: <a href="TPReport_Publish.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">Publish</a> Report<br>
:: <a href="TPReport_Edit1.cfm?ID=#URL.ID#&Year=#URL.Year#&AuditedBy=#URL.AuditedBy#">Edit</a> Report<br>
</cfif>
</cfoutput>
<br><br>  
...
<cfif col is "Comments" or col is "Year_" or col is "ID" or col is "AuditedBy">
<cfelse>
...
<cfif col is "Year_" or col is "ID" or col is "Comments" or col is "AuditedBy">
<cfelse>
...
<br>
Return to <a href="auditdetails?ID=#URL.ID#&Year=#URL.Year#">Audit Details</a> for this Audit.
</cfif>
