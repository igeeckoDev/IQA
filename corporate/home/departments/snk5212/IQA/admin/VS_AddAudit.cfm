...
<cfset subTitle = "Verification Services - Add Internal Audit">
...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="VS_AddAudit_Submit.cfm">
...
<INPUT TYPE="Hidden" NAME="AuditedBy" VALUE="VS">
<INPUT TYPE="Hidden" NAME="AuditType" VALUE="Verification Services">
<INPUT TYPE="Hidden" NAME="AuditType2" VALUE="Verification Services - Site Audit">
...
<u>Note</u> - If you do not see the Auditor in the drop down list above, please add the Auditor <a href="Auditors.cfm?Type=VS">here</a>.<br><br>
