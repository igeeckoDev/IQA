...
<cfset subTitle = "Verification Serices - Edit Audit #URL.Year#-#URL.ID#">
...
<cfoutput>					  
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="VS_EditAudit_Submit.cfm?#CGI.QUERY_STRING#">
</cfoutput>
