...
<cfset subTitle = "WiSE - Edit Audit #URL.Year#-#URL.ID#">
...
<cfoutput>					  
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="WiSE_EditAudit_Submit.cfm?#CGI.QUERY_STRING#">
</cfoutput>
...
<INPUT TYPE="Hidden" NAME="AuditedBy" VALUE="WiSE">
<INPUT TYPE="Hidden" NAME="AuditType" VALUE="WiSE Technical Audit">
<INPUT TYPE="Hidden" NAME="AuditType2" VALUE="WiSE Technical Audit">
...
<b>End Date</b>: <cfif len(EndDate)>#dateformat(EndDate, "mmmm dd, yyyy")#<cfelse>None Listed</cfif><br>
<b>Type of Audit</b>: WiSE Technical Audit<br /><br />
...
<u>Note</u> - If you do not see the Auditor in the drop down list above, please add the Auditor <a href="Auditors.cfm?Type=WiSE">here</a>.<br><br>
...
<CFOUTPUT QUERY="Details">
<b>Audit Area / Scope</b>:<Br />
<INPUT TYPE="TEXT" NAME="e_AuditArea" size="75" VALUE="#AuditArea#" displayname="Audit Area / Scope"><br /><br />
