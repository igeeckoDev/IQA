...
<cfset title = "#Request.SiteTitle# - Auditor Alerts - Add">
...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="addalert.cfm" onSubmit="return validateForm();">
...
Start Date<br>
<INPUT TYPE="Text" NAME="Start" VALUE="" onChange="return ValidateSDate()"><br><br>
End Date<br>
<INPUT TYPE="Text" NAME="End" VALUE="" onChange="return ValidateEDate()"><br><br>

Notes - explanation of Start/End Dates<br>
<textarea WRAP="PHYSICAL" ROWS="2" COLS="70" NAME="Notes" Value=""></textarea><br><br>

Details (&lt;br&gt; = carriage return, &lt;b&gt; bold text &lt;/b&gt; for bold text)<br>
<textarea WRAP="PHYSICAL" ROWS="7" COLS="70" NAME="Details" Value=""></textarea><br><br>
