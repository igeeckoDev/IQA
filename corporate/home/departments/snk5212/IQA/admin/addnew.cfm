...
WHERE Year_ = <cfqueryparam value="#Form.Year#" cfsqltype="cf_sql_integer">
</CFQUERY>

<CFQUERY BLOCKFACTOR="100" Datasource="Corporate" NAME="Query">
INSERT INTO AuditSchedule(ID, Year)
VALUES (#Query.newid#, <cfqueryparam value="#Form.Year#" cfsqltype="cf_sql_integer">)
</CFQUERY>
...
Email=<cfif Form.Email is "">null,<cfelse>'#Form.Email#',</cfif>
Scope='#FORM.Scope#',
Notes='#FORM.Notes#'
WHERE ID=#Query.newid# AND Year=<cfqueryparam value="#Form.Year#" cfsqltype="cf_sql_integer">
</CFQUERY>
...
Your data has been updated!<br><br>
<b>ID</b> - #Year#-#ID#<br>
<b>Scope</b> - #Scope#<br>
...
Additional Email Notification - #Email#<br>
</cfif>
