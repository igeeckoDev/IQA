...
:: <a href="InspectionPrograms.cfm">Inspection Programs</a><br>
:: <a href="CertPrograms.cfm">Certification Programs</a><br>
...
:: <a href="logout.cfm">Log Out</a> - </cfoutput> 
<cflock scope="SESSION" timeout="60">
<cfoutput>#SESSION.AUTH.Name#</cfoutput>
</cflock>
<cflock scope="SESSION" timeout="60">
<cfoutput> - #SESSION.Auth.accesslevel#</cfoutput>
</cflock><br><br>
...
:: <a href="prog.cfm?list=All&order=">All Programs (IQA + CPO + Others)</a><br>
...
:: <a href="fus.cfm">IC Regions/Locations</a><br>
:: <A HREF="javascript:popUp('../webhelp/webhelp.cfm')">IQA Web Help</a><br><br>
:: <a href="logout.cfm">Log Out</a> - </cfoutput> 
<cflock scope="SESSION" timeout="60">
<cfoutput>#SESSION.AUTH.Name#</cfoutput>
...
<cflock scope="SESSION" timeout="60">
<cfoutput> - Corporate #SESSION.Auth.accesslevel#</cfoutput>
</cflock><br><br>
<cfinclude template="approval.cfm">
</td>
</tr>
...
<tr>
<td width="600" colspan="2" class="blog-content" valign="top" align="left">
<br> :: <a href="logout.cfm">Log Out</a> - 
</cfoutput>
<cflock scope="SESSION" timeout="60">
<cfoutput>#SESSION.AUTH.Name#</cfoutput>
</cflock>
...
<a href="schedule.cfm?Year=#CurYear#&AuditedBy=#SESSION.Auth.SubRegion#&auditor=All">Audit Schedule</a></cfoutput>
 :: <a href="calendar.cfm?type=all">Audit Calendar</a> :: <a href="Aprofiles.cfm">Auditor List</a> :: <a href="metrics_region.cfm">Metrics</a> :: <a href="Accred.cfm">View Accreditors</a><br><a href="NotApproved.cfm">Audits Awaiting Approval</a> :: <a href="KBindex.cfm">Knowledge Base</a> :: <a href="select_office.cfm">Location Information</a><br><A HREF="javascript:popUp('../webhelp/webhelp.cfm')">IQA Web Help</a> :: <a href="logout.cfm">Log Out</a> - <cflock scope="SESSION" timeout="60">
<cfoutput>#SESSION.AUTH.Name#</cfoutput>
</cflock>
<cflock scope="SESSION" timeout="60">
<cfoutput> - #SESSION.Auth.accesslevel#</cfoutput>
...
&nbsp;&nbsp;<a href="admin.cfm">Main</a> :: <cfoutput><cfset CurYear = #Dateformat(now(), 'yyyy')#><a href="schedule.cfm?Year=#CurYear#&AuditedBy=IQA&auditor=All">Audit Schedule</a></cfoutput> :: <a href="calendar.cfm?type=all">Audit Calendar</a> :: <a href="Aprofiles.cfm">Auditor List</a> :: <a href="FAQ.cfm">FAQ</a> :: <a href="KBindex.cfm">Knowledge Base</a><br><a href="alert_view.cfm">Auditor Alerts</a> :: <a href="metrics_region.cfm">Metrics</a> :: <a href="TPTDP.cfm">TPTDP Locations and Certificates</a> :: <a href="auditor_req_view.cfm">Auditor Requests</a> :: <A HREF="javascript:popUp('../webhelp/webhelp.cfm')">IQA Web Help</a>
</td>
</tr>
<tr>
<td width="300" class="blog-content" valign="top" align="left">
...
<cfoutput>
:: <a href="Status.cfm?year=#curyear#">Scope Letter, Follow Up, and Report Status</a><br>
:: <a href="Status2.cfm?year=#curyear#">Audit Scope and Report Completion Status</a><br>
</cfoutput>
...
:: <a href="NotApproved.cfm">Audits Awaiting Approval</a><br>
:: <a href="viewControlPanel.cfm">Manage Lists</a><br>
...
:: <a href="logout.cfm">Log Out</a> - <cflock scope="SESSION" timeout="60">
<cfoutput>#SESSION.AUTH.Name#</cfoutput>
</cflock>
...
:: <a href="view_stats.cfm">Page Views</a>
</cfif>
</cflock>
