...
<cfif SESSION.Auth.AccessLevel NEQ "Auditor">
	<CFIF SESSION.Auth.accesslevel is "SU"
        ...
        <cfelse>
		 ...
		 - <a href="Status_CompletionNotes.cfm?year=#url.year#&id=#url.id#">Add/Edit</a> Audit Scope / Audit Report Completion Notes<br>
		<cfif NOT len(Status)>
...
<b>Scope</b><br>
<cfif Year GTE 2016 AND Year LT 2022>
	<cfif AuditType2 eq "MMS - Medical Management Systems">
	#Request.MMSScope#
	<cfelse>
	#Request.IQAScope2016#
	</cfif>
<cfelseif Year GTE 2023>	
	#Request.IQAScope2023#
...
<cfif isDefined("CompletionNotes")>
	...
	<b>Audit Scope / Audit Report Completion Notes:</b> [<a href="Status_CompletionNotes.cfm?year=#url.year#&id=#url.id#">Edit</a>]
	<br>
