...
<br>The Report for this Audit has not been completed. Please complete the Audit Report before recording the Close Out Letter.<br><br>
<cfoutput>
...
<cflocation url="followup_send.cfm?ID=#ID#&Year=#Year#">

<cfelse>

<cfoutput query="Car">
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="followup_send.cfm?ID=#ID#&Year=#Year#">
