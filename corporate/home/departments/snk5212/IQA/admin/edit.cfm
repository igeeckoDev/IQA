...
<cfoutput query="ScheduleEdit">
<!---desk audit--->
<b>Is this an on-site, remote or blended Audit?</b> <u>Currently</u>: 
<cfif Desk is "Yes">Desk Audit<cfelseif Desk is "Blended">Blended Audit<cfelseif Desk is "No">On-site Audit<cfelse><font class="warning">No Selection</cfif><br>
				
<cfswitch expression="#Desk#">
	<cfcase value="Yes">
	Desk <INPUT TYPE="Radio" name="Desk" value="Yes" checked> Blended <INPUT TYPE="Radio" name="Desk" value="Blended"> On-site <INPUT TYPE="Radio" name="Desk" value="No">
	</cfcase>
	<cfcase value="Blended">
	Desk <INPUT TYPE="Radio" name="Desk" value="Yes"> Blended <INPUT TYPE="Radio" name="Desk" value="Blended" checked> On-site <INPUT TYPE="Radio" name="Desk" value="No">
	</cfcase>
	<cfcase value="No">
	Desk <INPUT TYPE="Radio" name="Desk" value="Yes"> Blended <INPUT TYPE="Radio" name="Desk" value="Blended"> On-site <INPUT TYPE="Radio" name="Desk" value="No" checked>
	</cfcase>
	<cfcase value="">
	Desk <INPUT TYPE="Radio" name="Desk" value="Yes"> Blended <INPUT TYPE="Radio" name="Desk" value="Blended"> On-site <INPUT TYPE="Radio" name="Desk" value="No">
	</cfcase>
</cfswitch><br><br>
</CFOUTPUT>
</cfif>
	...
	<cfoutput>
        ...
        <cfif ScheduleEdit.AuditedBy is "IQA">
				...
				<SELECT NAME="BusinessUnit" multiple="multiple" size="7" displayname="Business Unit">
					...
					<OPTION VALUE="Enterprise & Advisory Services ">Enterprise & Advisory Services</OPTION>
<OPTION VALUE="Customer Experience Team ">Customer Experience Team </OPTION>
...
:: <a href="https://ul.sharepoint.com/sites/Intranet/_layouts/15/search.aspx/people" target="_Blank">Look Up Email</a> - <b>Use UL External Email addresses Only</b><br><br>
<!---
...
- Audit notification will be sent to this person or persons. <font class="warning">Add commas between email addresses</font><br>
