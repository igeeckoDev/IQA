	...
	<cfif SESSION.Auth.AccessLevel eq "Admin"
	  ...
	  OR SESSION.Auth.AccessLevel eq "SU">
		...
		<u>CAR, DAP, IQA Record Storage Categories</u><br>
		 ...
		 :: <a href="#SiteDir#IQA/Admin/ViewFiles.cfm?CategoryID=10">IQA Audit Planning</a> (for 2013-2014, see <a href="AuditPlanning.cfm?Year=#nextyear#">Audit Planning Module</a> for 2015+ Audit Planning<br>
	...
	<cfif SESSION.Auth.AccessLevel eq "Admin"
	  ...
	  OR SESSION.Auth.AccessLevel eq "IQAAuditor" >
		<u>Audit Planning Matrix</u><br>
		 :: <a href="#SiteDir#IQA/Admin/AuditPlanning.cfm?Year=#nextyear#">Auditor Planning Matrix (IQA)</a><br><br>
	</cfif>
