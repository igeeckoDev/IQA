...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" name="Audit" ACTION="reschedule_confirm.cfm?ID=#ID#&Year=#Year#" onSubmit="return validateForm();">
...
<b>Start Date</b> (please use this format - mm/dd/yyyy)<br>
<INPUT TYPE="Text" NAME="StartDate" VALUE="<cfif StartDate is NOT ""><cfset Start = #StartDate#>#DateFormat(Start, 'mm/dd')#/#year#</cfif>" onchange="return ValidateSDate()"><br><br>
...
<textarea WRAP="PHYSICAL" ROWS="7" COLS="70" NAME="e_RescheduleNotes" displayname="Reschedule Notes" Value=""></textarea><br><br>

<u>Note</u> - Please send an email request for the reschedule to Denise including the correspondence with the Auditee. Denise will approve the request and post the correspondence as evidence and approval.<br><br>
