...
<cfset subTitle = "Audit Scope and Report Completion Status - #url.year#">
...
<cflock scope="SESSION" timeout="90">
    ...
    <cfif SESSION.AUTH.AccessLevel is "IQAAuditor" 
		OR SESSION.Auth.AccessLevel neq "IQAAuditor" 
		AND SESSION.AUTH.AccessLevel neq "SU" 
		AND SESSION.Auth.IQA eq "Yes">
...
<cfif URL.Year is LastYear>
	<b>#LastYear#</b> <a href="status2year.cfm?Year=#CurYear#&month=1">[ #CurYear# ]</a> <a href="status2year.cfm?Year=#NextYear#&month=1">[ #NextYear# ]</a><br><br>
<cfelseif URL.Year is CurYear>
	<a href="status2year.cfm?Year=#LastYear#&month=#curmonth#">[ #LastYear# ]</a> <b>#CurYear#</b> <a href="status2year.cfm?Year=#NextYear#&month=#curmonth#">[ #NextYear# ]</a><br><br>
<cfelseif URL.Year is NextYear>
	<a href="status2year.cfm?Year=#LastYear#&month=1">[ #LastYear# ]</a> <a href="status2year.cfm?Year=#CurYear#&month=1">[ #CurYear# ]</a> <b>#NextYear#</b> <br><br>
</cfif>
...
<table border="1" class="sched-content">
...
<cfelse>
	<cfif M IS NOT Month>
		<cfIf M is NOT "">
        <tr>
            <td colspan="6" align="right" class="sched-title"><a href="##Top">Top <img src="../images/top.gif" alt="" height="7" width="5" border="0"></a>&nbsp;</td>
        </tr>
        </cfif>
        <tr>
            <td colspan="6" class="sched-title"><a name="#Month#"></a><b><u>#MonthAsString(Month)#</u></b></td>
        </tr>
        <tr>
    ...
    No Scope<br />
        ...
        <cfelseif Year lt curyear>
            <cfif CompletionNotes is "">
                <Br><A HREF="javascript:popUp('Status_CompletionNotes.cfm?year=#year#&id=#id#&page=status2')">Add Notes</A>
            <cfelse>
                <br><b><a href="javascript:popUp('Status_vCompletionNotes.cfm?year=#year#&id=#id#&page=status2')">View Notes</a></b>
            </cfif>
        </cfif>
	</cfif>
	</td>
