...
<cfmail to="Global.InternalQuality@ul.com" from="Internal.Quality_Audits@ul.com" subject="DEV TESTING - Audit Reschedule - #Schedule.ExternalLocation#" bcc="Internal.Quality_Audits@ul.com">
...
<cfif RescheduleNextYear is "Yes">
<cfmail to="Global.InternalQuality@ul.com" from="Internal.Quality_Audits@ul.com" subject="DEV TESTING - Audit Reschedule - #Schedule.OfficeName#, #Schedule.AuditArea#">
DEVELOPMENT SERVER TESTING - PLEASE DISREGARD
...
<cfelse>
<cfif RescheduleNextYear is "Yes">
<cfmail to="Global.InternalQuality@ul.com, Internal.Quality_Audits@ul.com" from="Internal.Quality_Audits@ul.com" subject="Audit Reschedule - #Schedule.OfficeName#, #Schedule.AuditArea#">
The Audit of #Schedule.Officename# (#Trim(Schedule.AuditArea)#, #URL.Year#-#URL.ID#) scheduled for #OrigMonth#, #Schedule.Year# has been rescheduled to #NewMonth#, #NextYear# (#NextYear#-#NextYr.ID#).
