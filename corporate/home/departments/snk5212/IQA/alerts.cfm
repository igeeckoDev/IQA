                  ...
                  <tr> 
                    <td valign="top" class="content-column-left"> 
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr> 
                          ...
                          <td width="94%" align="left" class="blog-content"><p align="left"><br>
							  ...
							  <cfif len(Trim(Start_)) AND NOT len(Trim(End))>
							  Effective <cfset S = #Start_#>#DateFormat(S, 'mm/dd/yyyy')#<br><br>
							  <cfelseif len(Trim(Start_)) AND len(Trim(End))>
							  Effective from <cfset S = #Start_#>#DateFormat(S, 'mm/dd/yyyy')# to <cfset E = #End#>#DateFormat(E, 'mm/dd/yyyy')#<br><br>
							  <cfelseif NOT len(Trim(Start_)) AND len(Trim(End))>
							  Effective until <cfset E = #End#>#DateFormat(E, 'mm/dd/yyyy')#<br><br>
							  <cfelseif NOT len(Trim(Start_)) AND NOT len(Trim(End))>
							  <cfelse>
							  Effective from <cfset S = #Start_#>#DateFormat(S, 'mm/dd/yyyy')# to <cfset E = #End#>#DateFormat(E, 'mm/dd/yyyy')#<br><br>
							  </cfif>
							  <cfif len(trim(Notes))><b>Notes:</b> #Notes#<br><br></cfif>
							 <cfif len(trim(File_))><b>Attached File:</b> <a href="alertdocs/#File_#">View</a><br><br></cfif>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          <td width="3%" height="20" align="right"><p>&nbsp;</p></td>
                          <td width="95%" align="left" class="blog-title"><p align="left"></p></td>
                          <td width="2%" align="right" nowrap class="blog-time">&nbsp;</td>
                        </tr>
                        <tr> 
                          <td width="3%"></td>
