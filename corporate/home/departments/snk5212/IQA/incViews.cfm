<!---
<cfif cgi.remote_addr is NOT "10.40.118.45">
<cfelseif cgi.remote_addr is NOT "10.40.118.53">
<cfelseif cgi.remote_addr is NOT "10.40.106.138">
<cfelse>
	<cfinclude template="views.cfm">
</cfif>
--->

<cfif cgi.remote_addr is "10.40.118.45">
