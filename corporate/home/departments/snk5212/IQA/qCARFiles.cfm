...
<cfloop query="Categories">
	...
	<cfloop query="DocNo">
		...
		<cfif CatOutput.CategorySecure is "No" AND CatOutput.CategoryID eq CatID>
...
#Year_# Plan :: <a href="#IQARootDir#FSPLan/#File_#">View</a><br>
	...
	<cfoutput>
		<b>UL LLC Site Status</b><br>
		<a href="https://ul.sharepoint.com/sites/quality/539/Shared Documents/Staff Directories/Staff Assigned to Invalid Locations in Oracle" target="_blank">Staff in Oracle with INVALID location</a>
	</cfoutput>
</cfif>