...
SELECT auditschedule.report, auditschedule.status, auditschedule.month,"AUDITSCHEDULE".YEAR_ as "Year", auditschedule.id, auditschedule.audittype, externallocation.externallocation, externallocation.watch
...
</cfif> AND  year = <cfqueryparam value="#URL.Year#" cfsqltype="cf_sql_integer">
 AND  audittype = 'TPTDP'
 ORDER BY Month, AuditSchedule.ID
