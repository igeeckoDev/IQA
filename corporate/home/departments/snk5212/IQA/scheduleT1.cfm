...
<CFQUERY BLOCKFACTOR="100" NAME="Total" Datasource="Corporate2">
...
<!--- cancelled --->
<CFQUERY BLOCKFACTOR="100" NAME="TotalCancel" Datasource="Corporate2">
SELECT Count(*) as Count
FROM AuditSchedule
...
<CFQUERY BLOCKFACTOR="100" NAME="Details" Datasource="Corporate2">
SELECT AuditSchedule.*, AuditSchedule.Year_ as Year FROM AuditSchedule
