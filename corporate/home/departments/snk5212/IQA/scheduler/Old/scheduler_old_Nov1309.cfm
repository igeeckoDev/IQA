...
<!--- IQA DB --->
<cfinclude template="incIQAbackupAM.cfm">	

<!--- CAR DB --->
<cfinclude template="incCARbackupAM.cfm">

<!---<cfmail 
	from="Internal.Quality_Audits@ul.com" 
	to=	"Christopher.j.nicastro@ul.com"
	subject="IQA Database AM Backup - #Month# #Day#, #Year#" 
	Mailerid="Backup">
IQA Database Backed up.
Back up file #basedir#BackupDB\IQADB_#Month#_#Day#_#Year#_AM.mdb created.
</cfmail>--->
...
<cfmail 
	query="SelectAudits"
	from="Internal.Quality_Audits@ul.com" 
	to=	"#Email#, #Email2#, William.R.Carney@ul.com, #RQM#, #QM#, #GM#, #LES#, #Other#, #Other2#, Jola.Wroblewska@ul.com, Ronald.C.Vaickauski@ul.com"
...
<cfmail 
	...
	from="Internal.Quality_Audits@ul.com" 
	to=	"#Email#, #Email2#, Jola.Wroblewska@ul.com, Ronald.C.Vaickauski@ul.com"
	cc= "global.internalquality@ul.com"
	bcc= "Christopher.j.nicastro@ul.com"
