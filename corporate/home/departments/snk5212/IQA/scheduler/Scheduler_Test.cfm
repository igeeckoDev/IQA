...
SELECT Email 
FROM AuditorList
WHERE Auditor = '#SelectAudits.LeadAuditor#'
</CFQUERY>
...
<cfif len(SelectAudits.Auditor)>
    <cfloop index = "ListElement" list = "#SelectAudits.Auditor#"> 
        <Cfoutput>
            <CFQUERY BLOCKFACTOR="100" NAME="AuditorEmail" Datasource="Corporate">
            SELECT Email 
            FROM AuditorList
...
<cfif len(SelectAudits.AuditorInTraining)>
    <cfloop index = "ListElement" list = "#SelectAudits.AuditorInTraining#"> 
        <Cfoutput>
            <CFQUERY BLOCKFACTOR="100" NAME="AuditorEmail" Datasource="Corporate">
            SELECT Email 
            FROM AuditorList
...
<cfif AuditType2 eq "Program">
    ...
    <cfif len(ProgramContacts.SEmail)><cfset OtherContacts = listAppend(otherContacts, "#ProgramContacts.SEEmail#")></cfif>
...
from="Internal.Quality_Audits@ul.com"<br />
to=	"#ToEmails#"<br />
cc="#AuditorCCEmails#"<br />
bcc= "#AllAuditContactsBCC#"<br />
replyto = "#LeadAuditorEmail#"><br />
subject="IQA Audit Notification - Quality System Audit of #incSubjectTitle#"<br /><br />
