...
If you have forgotten your user name, select the link below the login form entitled <u>Send Username</u>. Enter your external UL email address and select 'submit info'. Your user name and password will be sent to your email address on record. If your email address is not found, first please check the spelling and syntax or use the <a href="http://usnbkiqas100p/phonelist/">Employee Directory</a> to verify your external email address. If it is still not found, you may not have an account for this system. Please contact <a href="mailto:Christopher.J.Nicastro@ul.com">Chris Nicastro</a> for further assistance.<br><br>
