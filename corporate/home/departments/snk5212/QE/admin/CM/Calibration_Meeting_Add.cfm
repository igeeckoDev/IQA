...
<cfset SubTitle = "Quality Engineering - Add Calibration Meeting">
...
<cfelse>
	...
	<b>Start Date</B><br>
	<INPUT TYPE="Text" NAME="e_StartDate" VALUE="" onchange="return Validate_e_StartDate()" displayname="Meeting Start Date"><br><br>
	
	<b>End Date</B><br>
	<INPUT TYPE="Text" NAME="e_EndDate" VALUE="" onchange="return Validate_e_EndDate()" displayname="Meeting End Date"><br><br>
