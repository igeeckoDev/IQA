...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="#SiteDir#Siteshared/cr_style_test.css" />
	<link rel="stylesheet" type="text/css" media="print" href="#SiteDir#Siteshared/cr_style_test.css" />
    ...
    <script type="text/javascript" src="http://<cfoutput>usnbkiqas100p</cfoutput>/header/jquery-1.2.6.js"></script>
    <!--[if lte IE 7]>
...
<table border="0" cellspacing="0" cellpadding="0" width="800">
	<tr>
    	...
    	<td align="left" valign="top" width="642" height="23">
		<cfoutput>
        	<div id="navdate">
			<!--- Quality Engineering --->
