...
ULmenu[0]='<a href="https://ul.sharepoint.com/sites/Intranet" target="_blank">UL Net Home</a>'
...
Helpmenu[0]='<a href="#SiteDir#IQA/KPI.cfm">KPI</a>'
...
<cfif IsDefined("SESSION.Auth.IsLoggedIn") AND this.Name eq "IQA">
	...
	<cfelseif SESSION.Auth.AccessLevel eq "RQM">
		...
		IQA_AdminMenu[3]='<a href="#SiteDir#IQA/Admin/Aprofiles.cfm?View=All">Auditor List and Profiles</a>'
		IQA_AdminMenu[4]='<a href="#SiteDir#IQA/Admin/AuditPlanning.cfm?Year=#nextyear#">Auditor Planning Matrix (IQA)</a>'
