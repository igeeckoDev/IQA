...
<cfif isDefined("Form.AppealResponseEmail") AND isDefined("Form.Submit")>
	...
	<cfif Form.DueDate lte curdate>
    	<cflocation url="TechnicalAudits_AssignAppealResponse.cfm?#CGI.QUERY_STRING#&msg=The Due Date must be a future date" addtoken="no">
   </cfif>
...
<cfFORM ACTION="#CGI.Script_Name#?ID=#URL.ID#&Year=#URL.Year#&Person_ID=#URL.Person_ID#" METHOD="POST" NAME="Email">
