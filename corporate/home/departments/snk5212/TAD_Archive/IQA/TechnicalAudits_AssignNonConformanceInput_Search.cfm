...
<cfif isDefined("Form.Submit")>
	<cfoutput>
	    <b>Select Non-Conformance Input Employee - Search Results (#Form.Last_Name#)</b><br />
    </cfoutput>
    ...
    #first_n_middle# #last_name# - #employee_email# <A href="TechnicalAudits_AssignNonConformanceInput.cfm?ID=#ID#&Year=#Year#&Person_ID=#Person_ID#">[Select]</A><br>
    </cfoutput>
<cfelse>
	<cfoutput>
    ...
    <b>Select Non-Conformance Input Employee - Search by Last Name</b><br />
