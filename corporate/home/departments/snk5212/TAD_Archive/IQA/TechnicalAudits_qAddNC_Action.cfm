...
:: <a href="TechnicalAudits_AddNC_SelectItem.cfm?Year=#URl.Year#&ID=#URL.ID#&CategoryID=#CategoryID#">Confirm</a><br>
:: <a href="TechnicalAudits_AddNC_Edit.cfm?#CGI.Query_String#">Edit</a><br><br>
</cfoutput>
...
<tr>
    ...
    <td valign="top" align="left">#replace(Evaluate("Form.Analysis_#ID#"), "'", "!", "All")#
    </td>
</tr>
</cfoutput>
</Table>