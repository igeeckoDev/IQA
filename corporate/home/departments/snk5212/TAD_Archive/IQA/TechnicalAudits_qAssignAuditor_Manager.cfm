...
<b>Select Auditor's Manager</b><br />
<Cfoutput query="qEmpLookup">
Name: #Supervisor_Name# <a href="#IQADir#TechnicalAudits_AssignAuditor_Manager_Search_Action.cfm?ID=#ID#&Year=#Year#&Person_ID=#Supervisor_Person_ID#">
