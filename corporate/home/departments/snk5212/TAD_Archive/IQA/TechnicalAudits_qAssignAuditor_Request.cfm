...
<cfif qresult eq 0>
	...
	<a href="#IQADir#TechnicalAudits_AssignAuditor_Request_Search.cfm?#CGI.Query_String#">Search</a> again.
    </cfoutput>
<cfelseif qresult eq 1>
	Results:<br>
	<cfoutput>
	- #v_name#, #Location#, #Department# <a href="#IQADir#TechnicalAudits_AssignAuditor_Request_Action.cfm?Auditor=#v_name#&EmpNo=#EmpNo#&Email=#v_Email#&Location=#Location#&Department=#Department#&#CGI.Query_String#">[select]</a><br>
	</cfoutput>
<cfelseif qresult eq 2>
	...
	<td class="blog-content"><a href="#IQADir#TechnicalAudits_AssignAuditor_Request_Action.cfm?Auditor=#v_name#&EmNo=#EmpNo#&Email=#v_Email#&Location=#Location#&Department=#Department#&#CGI.Query_String#">Add Auditor</a></td>
	</tr>
	</cfoutput>
	</table>
</cfif>