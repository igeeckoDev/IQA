...
<cfset subTitle = "Internal Technical Audits - Auditor List - Request Auditor - Details">
...
<CFFORM METHOD="POST" ENCTYPE="multipart/form-data" name="Accred" action="TechnicalAudits_AssignAuditor_Request_Action_Submit.cfm?#CGI.Query_String#">
<cfoutput>
<u>Name</u>:<br>
#URL.Auditor#
