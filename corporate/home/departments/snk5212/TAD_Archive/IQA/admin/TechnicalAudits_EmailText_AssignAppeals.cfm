...
You have been assigned the Appeals from the #AuditType2# Technical Audit <B>#ReviewLoc#-#ProjectNumber#-#CCN#-#AuditorLoc#-#AuditTypeID##RequestTypeID#</B>.<Br><br>
...
Your review of the Appeals should be completed by the end of business on #dateformat(AppealDueDate, "mm/dd/yyyy")#.<br /><br />
