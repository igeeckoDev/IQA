...
You have been assigned the Non-Conformance Input from the #AuditType2# Technical Audit <B>#ReviewLoc#-#ProjectNumber#-#CCN#-#AuditorLoc#-#AuditTypeID##RequestTypeID#</B>.<Br><br>
...
The Non-Conformance Input should be completed by the end of business on #dateformat(DueDate, "mm/dd/yyyy")#.<br /><br />
