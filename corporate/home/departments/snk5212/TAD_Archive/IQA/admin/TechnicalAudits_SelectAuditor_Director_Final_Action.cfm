...
<cfoutput query="qEmpLookup">
    ...
    SET
    EngManagerDirector = '#first_n_middle# #last_name#',
    EngManagerDirectorEmail = '#Email#',
    EngManagerDirectorDept = '#Department#',
    EngManagerDirectorOfficeName = '#Location#',
    History = <CFQUERYPARAM VALUE="#History.History#<br /><br />
    	Engineering Manager Director Assigned<br />
        Engineering Manager Director: #first_n_middle# #last_name# / #Location# / #Department#<Br />
...
<cflocation url="TechnicalAudits_SelectAuditor_ConfirmAll.cfm?ID=#URL.ID#&Year=#URL.Year#" addtoken="no">