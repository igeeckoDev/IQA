<cfif isDefined("Form.EmpNo")>
	<cfif url.page eq "TechnicalAudits_viewUser">
		<cflocation url="#url.page#.cfm?EmpNo=#Form.EmpNo#" addtoken="no">
	<cfelseif url.page eq "TechnicalAudits_AccessControl">
    	<cflocation url="#url.page#.cfm?EmpNo=#Form.EmpNo#" addtoken="no">
    </cfif>
<cfelse>
...
<cfform name="TempForm" action="#cgi.SCRIPT_NAME#?#cgi.QUERY_STRING#" method="post">
